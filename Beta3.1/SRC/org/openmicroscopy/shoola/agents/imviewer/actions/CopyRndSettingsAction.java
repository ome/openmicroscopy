/*
 * org.openmicroscopy.shoola.agents.imviewer.actions.CopyRndSettingsAction 
 *
 *------------------------------------------------------------------------------
	...
	extends ViewerAction
{
	...
	/** The description of the action. */
    private static final String DESCRIPTION = "Copy the current rendering " +
    											"settings.";
     ...
     */
	public CopyRndSettingsAction(ImViewer model)
	{
		super(model);
		name = NAME;
