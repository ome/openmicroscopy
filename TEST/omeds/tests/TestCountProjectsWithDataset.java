/*
 * omeds.tests.TestCountProjectsInDataset
 *
 *------------------------------------------------------------------------------
 *
 ...
 * @since OME2.2
 */
public class TestCountProjectsWithDataset
	extends OMEDSTestCase
{
	...
	public void testCountProjectsInDataset()
	{
		Criteria c = new Criteria();
		c.addWantedField("#projects");
		
		int datasetID = datasetRow.getID();
		Dataset d = (Dataset) omeds.load(Dataset.class, datasetID, c);
		
		assertEquals(numberProjects, d.countProjects());
	}
