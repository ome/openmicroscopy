/*
 * omeds.tests.ImageCriteriaFactory
 *
 *------------------------------------------------------------------------------
 *
 ...
 * @since OME2.2
 */
public class ImageCriteriaFactory
{
	/**
	...
	public static Criteria buildImageDatasetCriteria()
	{
		Criteria criteria = new Criteria();
		...
		criteria.addWantedField("datasets", "name");
  		...
  		criteria.addWantedField("datasets", "owner");
  		criteria.addWantedField("datasets.owner", "id");
  		criteria.addWantedField("datasets.owner", "FirstName");
  		criteria.addWantedField("datasets.owner", "LastName");
  		criteria.addWantedField("datasets.owner", "Group");

  		//Specify which fields we want for the owner's group.
  		criteria.addWantedField("datasets.owner.Group", "id");
  		criteria.addWantedField("datasets.owner.Group", "Name");
