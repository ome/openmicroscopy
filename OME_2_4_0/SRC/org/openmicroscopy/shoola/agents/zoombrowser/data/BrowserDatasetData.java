/*
 * org.openmicroscopy.shoola.agents.zoombrowser.data.BrowserDatasetData
 *
 *------------------------------------------------------------------------------
 *
 ...
 * @since OME2.2
 */
public class BrowserDatasetData  extends DatasetData implements Comparable
{
	...
	public BrowserDatasetData() {}
	
	public BrowserDatasetData(int id, String name)
	{
		super();
		setID(id);
		setName(name);
	...
	public DataObject makeNew() { return new BrowserDatasetData(); }
	...
	public int compareTo(Object o) {
		if (o instanceof BrowserDatasetData) {
			BrowserDatasetData d2 = (BrowserDatasetData) o;
