/*
 * org.openmicroscopy.shoola.agents.spots.ui.java2d.YZTrajectoryCanvas;
 *
 *------------------------------------------------------------------------------
 *
...
/** 
 * An canvas for drawing of trajectories in the YZ plane 
 * 
...
public class YZTrajectoryCanvas extends TrajectoryCanvas {
	
	public YZTrajectoryCanvas(double horizMax,double vertMax) {
	...
	protected Trajectory2D getTrajectoryRendering(SpotsTrajectory t) {
		Trajectory2D p = new YZTrajectory2D(this,t);
