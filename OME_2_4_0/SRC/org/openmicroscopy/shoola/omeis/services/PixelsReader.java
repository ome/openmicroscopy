/*
 * org.openmicroscopy.shoola.omeis.services.PixelsReader
 *
 *------------------------------------------------------------------------------
 *
...
package org.openmicroscopy.shoola.omeis.services;
    ...
    extends ImageService
{
    ...
    public void getStack(long pixelsID, int theC, int theT, 
                            boolean bigEndian, ByteArray buf)
        throws ImageServiceException;
