...
client = scripts.client("Write_Data-4.py",
    """Downloads a named file annotation on a Project""",
    # first parameter
    scripts.String("Data_Type", optional=False, values=dataTypes, default="Project"),
    # second parameter
...
for ann in project.listAnnotations():
    if isinstance(ann, omero.gateway.FileAnnotationWrapper):
        ...
        print "File ID:", ann.getFile().getId(), name, "Size:", ann.getFile().getSize()
        if fileName == name:
