/*
 * org.openmicroscopy.shoola.agents.imviewer.actions.HistogramAction
 *
 *------------------------------------------------------------------------------
 *
...
/** 
 * Brings up the histogram widget.
 *
    ...
    extends RndAction
{
    ...
    private static final String DESCRIPTION = "View the pixels intensity " +
            "values across time for the selected channel.";
    ...
    public HistogramAction(Renderer model)
    {
        ...
        putValue(Action.SMALL_ICON, icons.getIcon(IconManager.HISTOGRAM));
    }
