...
public class ColorsFactory
{
     ...
     * emission wavelength.
     * 
     * @param emWave The emission wavelength of the channel to determine the 
     *               color for.
     * @return A color.
     */
    private static Color getColor(int emWave)
    {
     ...
     * @return  A color.
     */
    public static Color getColor(int index, int emWave)
    {
        Color c = ColorsFactory.getColor(emWave);
        if (c != null) return c;
        switch (index) {
