/*
 * org.openmicroscopy.shoola.agents.hiviewer.actions.ClassifyChildrenAction 
 *
 *------------------------------------------------------------------------------
	...
	extends HiViewerAction
{
    ...
    /**
     * Notifies the model to classify the images contained in the
     * selected folder. 
    ...
    public void actionPerformed(ActionEvent e)
    {
    	...
    	model.classifyChildren(browser.getLastSelectedDisplay());
    }
