/*
 * org.openmicroscopy.shoola.agents.treeviewer.ProfileEditorLoader 
 *
 *------------------------------------------------------------------------------
 ...
 * {@link ProfileEditor} of the progress and the user in the case of errors. 
 * Subclasses should at least implement the <code>handleResult</code> method 
 * to feed the {@link ProfileEditor} back with the results.
 *
 ...
 * @since OME3.0
 */
public abstract class ProfileEditorLoader 
	extends DSCallAdapter
{

	/** The Editor this data loader is for. */
    protected final ProfileEditor      		viewer;
     ...
     */
    protected ProfileEditorLoader(ProfileEditor viewer)
    {
