/*
 * org.openmicroscopy.shoola.agents.treeviewer.actions.DeclassifyAction
 *
 *------------------------------------------------------------------------------
 *
...
/** 
 * Declassifies the currently selected image.
 *
    ...
    extends TreeViewerAction
{
    ...
    private static final String DESCRIPTION = "Declassify the currently " +
                                            "selected image.";
     ...
     */
    public DeclassifyAction(TreeViewer model)
    {
        super(model);
    ...
    {
        ClassifyCmd cmd = new ClassifyCmd(model, ClassifyCmd.DECLASSIFY);
        cmd.execute();
    }
