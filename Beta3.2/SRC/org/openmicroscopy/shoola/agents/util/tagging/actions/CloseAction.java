/*
 * org.openmicroscopy.shoola.agents.util.tagging.actions.CloseAction 
 *
 *------------------------------------------------------------------------------
	...
	extends TaggerAction
{
    ...
    public static final String DESCRIPTION = "Close the dialog.";
	 ...
	 */
	public CloseAction(Tagger model)
	{
		super(model);
