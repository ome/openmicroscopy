/*
 * org.openmicroscopy.shoola.util.roi.figures.EllipseTextFigure 
 *
  *------------------------------------------------------------------------------
		...
		implements TextHolderFigure
{
	...
	public EllipseTextFigure() 
	{
		this("Text", 0, 0, 30, 20);
	}

	public EllipseTextFigure(double x, double y, double w, double h)
	{
		this("Text", x, y, w, h);
	}
	...
	public EllipseTextFigure(String text, double x, double y, double w, double h) 
	{
		super(x, y, w, h);
