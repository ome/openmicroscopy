/*
 * org.openmicroscopy.shoola.util.roi.figures.RectangleTextFigure 
 *
 *------------------------------------------------------------------------------
		...
		implements TextHolderFigure
{
	...
	public RectangleTextFigure(double x, double y, double w, double h)
	{
		this("Text", x, y, w, h);
	}
	...
	{
		textBounds=
				new Rectangle2D.Double(getTextX(g), getTextY(g),
	...
	{
		return g.getFontMetrics(FONT_FACE.get(this)).stringWidth(
			getText().trim());
	}
	...
	private TextLayout getTextLayout()
	{
		if (textLayout==null)
		{
			...
			HashMap<TextAttribute, Object> textAttributes=
