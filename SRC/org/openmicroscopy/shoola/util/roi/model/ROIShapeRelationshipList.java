/*
 * org.openmicroscopy.shoola.util.roi.model.ROIShapeRelationshipList 
 *
  *------------------------------------------------------------------------------
 ...
 * @since OME3.0
 */
public class ROIShapeRelationshipList 
{
	long 	parentID;
	private ArrayList<Long> list;
	
	public ROIShapeRelationshipList(long id)
	{
		parentID = id;
		list = new ArrayList<Long>();
	}
	
	public void add(long relationshipID)
	{
