 	...
 	extends BatchCallTree
{
	 ...
	 * @return The {@link BatchCall}.
	 */
	private BatchCall annotateChildren(final TimeRefObject ref,
			final AnnotationData data)
	{
		return new BatchCall("Create dataset annotation.") {
			public void doCall() throws Exception
			{
				...
				//result = os.annotateChildren(ref, data);
			}
		};
	}
	 ...
	 * @param data		The Annotation object. Mustn't be <code>null</code>.
	 */
	public AnnotationSaver(TimeRefObject ref, AnnotationData data)
	{
		if (data == null) throw new IllegalArgumentException("No annotation.");
		if (ref == null) 
			throw new IllegalArgumentException("No period specified.");
		saveCall = annotateChildren(ref, data);
	}
