...
public class STSMapper
{
    ...
    //ISSUE: the :all: field may create big problems.
    //All data link to the target will be retrieved.
    //ISSUE: Should control the size of the list when the IN clause is applied.
