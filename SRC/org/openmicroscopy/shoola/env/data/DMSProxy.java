	...
	implements DataManagementService
{
	 ...
	 * 
	 */
	DMSProxy(RemoteCaller transport)
	{
	...
	{
		Object result = transport.dispatch("retrieveProject", new Integer(id));
		if (!(result instanceof Map))
			throw new RemoteException("Incompatible return type "+
									  result.getClass());
		return new ProjectDTO((Map) result);
	}
