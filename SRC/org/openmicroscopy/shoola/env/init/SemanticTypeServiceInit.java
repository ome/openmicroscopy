...
/** 
 * Register the {@link SemanticTypeService} in the Registry.
 *
 ...
 * @since OME2.2
 */
final class SemanticTypeServiceInit
	extends InitializationTask
{
	 ...
	 */
	SemanticTypeServiceInit(Container c)
	{
		super(c);
	}
	/**
	...
	String getName()
	{
		return "Loading SemanticTypeService configuration";
	}
	/** 
		...
		throws StartupException
	{
		...
		try {
			...
			throw new StartupException(
					"Unable to load SemanticTypeService configuration",
										ce);
		}
