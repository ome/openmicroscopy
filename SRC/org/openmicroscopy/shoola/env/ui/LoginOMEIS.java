/*
 * org.openmicroscopy.shoola.env.ui.LoginOMEIS
 *
 *------------------------------------------------------------------------------
 *
	...
	extends JDialog
{
	...
	*/
	...
	LoginOMEIS(Container container)
	{
		super((JFrame) container.getRegistry().getTopFrame().getFrame(), true);
		this.container = container;
		LoginOMEISManager manager = new LoginOMEISManager(container, this);
		initLoginFields();
		initLoginButton();
		buildGUI();
