/*
 * org.openmicroscopy.shoola.agents.metadata.TagLoader 
 *
 *------------------------------------------------------------------------------
...
/** 
 * Retrieves the tags linked to the object specified.
 * This class calls the <code>loadTags</code> method in the
	...
	extends MetadataLoader
{
	 ...
	 */
	public TagLoader(MetadataViewer viewer, TreeBrowserSet refNode, Class type, 
					long id)
	{
	...
	public void load()
	{
		handle = mhView.loadTags(type, id, -1, this);
	}
