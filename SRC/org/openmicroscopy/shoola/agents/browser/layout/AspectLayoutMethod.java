/*
 * org.openmicroscopy.shoola.agents.browser.layout.AspectLayoutMethod
 *
 *------------------------------------------------------------------------------
 *
 ...
 * @since OME2.2
 */
public interface AspectLayoutMethod
{
    /**
     * Sets the mandatory width-to-height ratio to be the specified value.
     * For example, a 640x480 has an aspect ratio of 1.33.
     * 
