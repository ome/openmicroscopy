...
public class ImportableObject
{
	...
	/** The number of folders to include in the path. */
	 ...
	 * @param numberOfFolders The number of folders to include in the path.
	 */
	ImportableObject(List<File> files, boolean archived, int numberOfFolders)
	{
		this.files = files;
	...
	/**
	 * Returns the number of folders to include in the path.
	 * 
	 * @return See above.
	 */
	public int getNumberOfFolders() { return numberOfFolders; }
