	...
	extends AbstractIconManager
{
    ...
    /** ID of the <code>Annotation 48</code> icon for the slider. */
    public static final int ANNOTATION_48 = 0;

    /** ID of the <code>Info</code> icon for the slider. */
    public static final int INFO = 1;
    
    /** ID of the <code>Progress</code> icon for the slider. */
    ...
    { 
        if (singleton == null) 
            singleton = new IconManager(AnnotatorAgent.getRegistry());
        return singleton; 
    }
