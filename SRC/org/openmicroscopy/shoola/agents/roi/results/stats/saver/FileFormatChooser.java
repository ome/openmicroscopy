/*
 * org.openmicroscopy.shoola.agents.roi.results.stats.saver.FileFormatChooser
 *
 *------------------------------------------------------------------------------
 *
    ...
    extends JFileChooser
{
    ...
    private static final String     DEFAULT_FORMAT = TEXTFilter.TEXT;
                                ...
                                File[] list)
    {
        ...
        manager.setInfo(format, fileName, message);
        if (!exist) {
            display = false;
            manager.saveROIResult();
            cancelSelection(); 
        } else manager.showSelectionDialog();
    }
