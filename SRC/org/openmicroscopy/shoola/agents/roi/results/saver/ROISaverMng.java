/*
 * org.openmicroscopy.shoola.agents.roi.results.util.ROISaverMng
 *
 *------------------------------------------------------------------------------
 *
...
class ROISaverMng
{
    ...
    ROISaverMng(ROISaver view, ROIAgtCtrl control) 
    {
        this.view = view;
        ...
        if (null == null) 
            ...
            try {
                if (format.equals(TEXTFilter.TEXT))
                    WriterText.writeTableAsText(f, null);
                else if (format.equals(XMLFilter.XML))
                    WriterText.writeTableAsXML(f, null);
