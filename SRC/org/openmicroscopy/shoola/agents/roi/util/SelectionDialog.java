/*
 * org.openmicroscopy.shoola.agents.roi.util.SelectionDialog
 *
 *------------------------------------------------------------------------------
 *
    ...
    extends OptionsDialog
{
    ...
    private ROIStatsSaverMng        manager;

    protected String                format, fileName, message;
    
    SelectionDialog (ROIStatsSaverMng manager, String format, 
                        String fileName, String message, Icon messageIcon) 
    {
        super(manager.getView(), ROIStatsSaver.TITLE, ROIStatsSaver.MESSAGE, 
                messageIcon);
