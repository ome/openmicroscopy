/*
 * org.openmicroscopy.shoola.agents.roi.util.FileFormatChooser
 *
 *------------------------------------------------------------------------------
 *
    ...
    extends JFileChooser
{
    ...
    public FileFormatChooser(ROIStatsSaverMng manager)
    {
    ...
    public void approveSelection()
    {
        ...
        if (file != null) {
            ...
            String message = ROIStatsSaver.MSG_DIR+""+getCurrentDirectory();
