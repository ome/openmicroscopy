/*
 * org.openmicroscopy.shoola.agents.util.tagging.TaggerLoader 
 *
 *------------------------------------------------------------------------------
...
/** 
 * Parent of all classes that load data asynchronously for a {@link Tagger}.
 ...
 * {@link Tagger} of the progress and the user in the case of errors. 
 * Subclasses should at least implement the <code>handleResult</code> method 
 * to feed the {@link Tagger} back with the results.
 *
 ...
 * @since OME3.0
 */
public abstract class TaggerLoader
	extends DSCallAdapter
{

	/** The Tagger this data loader is for. */
	protected final Tagger				viewer;
     ...
     */
    protected TaggerLoader(Tagger viewer)
    {
    	if (viewer == null) throw new NullPointerException("No viewer.");
    	this.viewer = viewer;
    	registry = TaggerFactory.getRegistry();
