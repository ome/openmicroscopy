/*
 * org.openmicroscopy.shoola.agents.util.tagging.actions.TaggerAction 
 *
 *------------------------------------------------------------------------------
	...
	implements ChangeListener
{
    ...
    {
        setEnabled(model.getState() == Tagger.READY);
        onStateChange(e);
    }
