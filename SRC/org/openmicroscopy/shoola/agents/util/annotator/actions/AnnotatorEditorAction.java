/*
 * org.openmicroscopy.shoola.agents.util.annotator.actions.AnnotatorEditorAction 
 *
 *------------------------------------------------------------------------------
 ...
 * @since OME3.0
 */
public class AnnotatorEditorAction 	
	extends AbstractAction
	implements ChangeListener
{
	
	/** Reference to the <code>Model</code>. */
	protected AnnotatorEditor model;
	 ...
	 */
	public AnnotatorEditorAction(AnnotatorEditor model)
	{
		super();
	    setEnabled(false);
