/*
 * org.openmicroscopy.shoola.agents.hiviewer.tframe.ViewModeButton
 *
 *------------------------------------------------------------------------------
 *
    ...
    implements TinyFrameObserver, PropertyChangeListener, ActionListener
{
    ...
    private void displayMenu()
    {
        ...
        if (curView != null) {
            ...
            if (curView instanceof TinyFrame) 
                title = ((TinyFrame) curView).getTitle();
     ...
     */
    ViewModeButton(TinyFrame model)
    {
    ...
    { 
        ...
        model.addPropertyChangeListener(TinyFrame.SINGLE_VIEW_PROPERTY, this);
    ...
    public void detach() 
    { 
        model.removePropertyChangeListener(TinyFrame.SINGLE_VIEW_PROPERTY, 
                                           this); 
    }
