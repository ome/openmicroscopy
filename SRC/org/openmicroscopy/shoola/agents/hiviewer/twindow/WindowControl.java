/*
 * org.openmicroscopy.shoola.agents.hiviewer.twindow.WindowControl
 *
 *------------------------------------------------------------------------------
 *
...
/** 
 * Handles input events directed to the {@link TinyWindow} components and also 
    ...
    PropertyChangeListener, ActionListener, MouseListener, MouseMotionListener
{
    ...
    private TinyWindow       model;
    
    /** The window's UI. */
    private TinyWindowUI     view;
   
    /** The mouse events controller. */
    private ScreenControl   sControl;
    
    /**
     * Creates a new instance to control a given {@link TinyWindow} and
     * notify its View.
     * 
     * @param model The window. Mustn't be <code>null</code>.
     * @param view The window's UI. Mustn't be <code>null</code>.
     */
    WindowControl(TinyWindow model, TinyWindowUI view)
    {
    ...
    TinyWindow getModel() { return model; }
