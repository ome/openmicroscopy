/*
 * org.openmicroscopy.shoola.agents.datamng.editors.project.CreateProjectDatasetsPane
 *
 *------------------------------------------------------------------------------
 *
	...
	extends JPanel
{
	...
	private void setTableLayout(JTable table)
	{
		...
		tc.setHeaderValue(txt);
        table.setDefaultRenderer(DatasetData.class,
                            new DatasetsTableRenderer());
	}
    ...
    private class DatasetsTableRenderer
