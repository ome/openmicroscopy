/*
 * org.openmicroscopy.shoola.agents.datamng.editors.categoryGroup.CreateImagesPane
 *
 *------------------------------------------------------------------------------
 *
    ...
    extends JPanel
{
    ...
    CreateImagesPane(CreateEditorManager manager, List images)
    {
    ...
    private void buildGUI(List images)
    {
        setLayout(new GridLayout(1, 1));
        add(buildDatasetsPanel(images));
        Border b = BorderFactory.createEmptyBorder(0, 0, 10, 10);
        setBorder(b);
    }
    
    private JPanel buildDatasetsPanel(List images)
    {
        //select button
        ...
        extends AbstractTableModel
    {
        ...
        private ImagesTableModel(List l)
        {
            images = l.toArray();
