	...
	implements ActionListener
{
	...
	private ImportImageChooser	view;
	...
	ImportImageChooserMng(ImportImageChooser view, 
	...
	void attachListener()
	{
		JButton saveButton = iiSelection.getBar().getSaveButton(), 
				cancelButton = iiSelection.getBar().getCancelButton(),
				removeButton = iiSelection.getBar().getRemoveButton();
	...
	void setSelectionView(ImportImageSelection iiSelection)
	{
		this.iiSelection = iiSelection;
	}
	...
	{
		JComboBox cb = iiSelection.getSelectionPane().getExistingDatasets();
	...
	private void cancel() { view.closeWindow(); }
