/*
 * org.openmicroscopy.shoola.agents.measurement.ChannelMetadataLoader 
 *
 *------------------------------------------------------------------------------
	...
	extends MeasurementViewerLoader
{
     ...
     * 					Mustn't be <code>null</code>.
     */
	public ChannelMetadataLoader(MeasurementViewer viewer, long pixelsID)
	{
		super(viewer);
    ...
    public void load()
    {
    	handle = idView.loadChannelMetadata(pixelsID, this);
    }
    ...
    public void handleResult(Object result)
    {
    	...
    	viewer.setChannelMetadata((List) result);
    }
