/*
 * org.openmicroscopy.shoola.agents.measurement.PixelsLoader 
 *
 *------------------------------------------------------------------------------
 ...
 * This class calls the <code>loadPixels</code> method in the
	...
	extends MeasurementViewerLoader
{
     ...
     */
	public PixelsLoader(MeasurementViewer viewer, long pixelsID)
	{
		super(viewer);
    ...
    public void load()
    {
    	handle = idView.loadPixels(pixelsID, this);
    }
