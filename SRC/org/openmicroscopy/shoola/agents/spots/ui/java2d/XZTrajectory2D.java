/*
 * org.openmicroscopy.shoola.agents.spots.ui.java2d.XZTrajectory2D;
 *
 *------------------------------------------------------------------------------
 *
...
public class XZTrajectory2D extends Trajectory2D { 

	
	public XZTrajectory2D(TrajectoryCanvas canvas,SpotsTrajectory trajectory) {
