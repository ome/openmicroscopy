/*
 * org.openmicroscopy.shoola.agents.rnd.PlaneSlicingDef
 *
 *------------------------------------------------------------------------------
 *
...
public class PlaneSlicingDef
{
	...
	/**
	 * Holds parameters used for the bit-plane slicing transformations.
	 * The order of the bit-plane 1-bit to 7-bit
	 * 
	 * @param planeIndex		bit-plane index
	 ...
	 * 							the level for bit-plane > bit-plane selected
	 */
	public PlaneSlicingDef(int lowerLimit, int upperLimit, int planeIndex)
	{
