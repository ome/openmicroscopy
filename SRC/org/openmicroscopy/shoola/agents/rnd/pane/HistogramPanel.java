    ...
    extends JPanel
{
    ...
    private static final Color      binColor = new Color(0, 0, 255, 150);
    ...
    /** Paint the histogram. */
    private void paintBins(Graphics2D g2D, int hEnd)
    {
        g2D.setColor(binColor);
        g2D.drawString("Pixels", 5, tS/2);
        g2D.drawString("intensity", 5, tS/2+hEnd+5);
