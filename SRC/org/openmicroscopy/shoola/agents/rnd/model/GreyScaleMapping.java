	...
	extends JPanel
{
	...
	GreyScaleMapping(Registry registry, TreeMap wavelengths)
	{
	...
	private void buildTable(TreeMap wavelengths)
	{
		...
		while (e.hasNext()) {
			...
			addRow(group, wave, data);
		}
	}
	
	/** Build a row in the table. */
	private void addRow(ButtonGroup group, String wave, WavelengthData data)
	{
		...
		table.setValueAt(rb, i, POS_RADIO);
	}
