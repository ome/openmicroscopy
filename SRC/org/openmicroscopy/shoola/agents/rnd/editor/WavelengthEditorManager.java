 ...
 * @since OME2.2
 */
class WavelengthEditorManager
	implements ActionListener
{
	private static final int	SAVE = 0;
	private WavelengthData 		wd;
	private WavelengthEditor 	view;
	private JButton				saveButton;
	WavelengthEditorManager(WavelengthEditor view, WavelengthData wd)
	{
		this.view = view;
		this.wd = wd;
	}
	
	WavelengthData getWavelengthData()
	{
		return wd;
	}
