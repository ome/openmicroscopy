/*
 * org.openmicroscopy.shoola.agents.rnd.QuantumFactory
 *
 *------------------------------------------------------------------------------
 *
...
class QuantumFactory
{
	...
	*/
    ...
    static final int   APPROX_ANY = 200;
    ...
    /*
    private static void verifyApprox(int approx)
    {
        if (approx != APPROX_ANY)
		throw new IllegalArgumentException("Unsupported approximation type");
    }
    */
