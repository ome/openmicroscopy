/*
 * org.openmicroscopy.shoola.util.ui.GraphicSliderUIF
 *
 *------------------------------------------------------------------------------
 *
    ...
    extends JPanel
{
    ...
    GraphicSliderUIF(int max)
    {
        initUI(max);
        repaint();
    }
    
    private void initUI(int max)
    {
    ...
    void setKnobColor(Color c) { knobColor = c; }
