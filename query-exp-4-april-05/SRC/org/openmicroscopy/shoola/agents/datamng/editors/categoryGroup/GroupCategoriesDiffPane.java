/*
 * org.openmicroscopy.shoola.agents.datamng.editors.categoryGroup.GroupCategoriesDiffPane
 *
 *------------------------------------------------------------------------------
 *
    ...
    extends JDialog
{
    ...
    private CategoriesTableModel            categoriesTM;
    ...
    private GroupCategoriesDiffPaneMng      manager;
    ...
    /**
     * Return the {@link GroupCategoriesDiffPaneMng manager} of the widget.
     */
    GroupCategoriesDiffPaneMng getManager() { return manager; }
    ...
    {
        int countCol = categoriesTM.getColumnCount()-1;
        for (int i = 0; i < categoriesTM.getRowCount(); i++)
            categoriesTM.setValueAt(val, i, countCol);
    }
    ...
    private void initButtons(List d)
    {
        ...
        selectButton.setToolTipText(
            UIUtilities.formatToolTipText("Select all categories."));
        //cancel button
    ...
    JPanel buildDatasetsPanel()
    {
        ...
        JTable t = new JTable();
        sorter = new TableSorter(categoriesTM);  
        t.setModel(sorter);
        ...
        extends AbstractTableModel
    {
        private final Object[]      categories = 
                                    manager.getCategoriesDiff().toArray();
