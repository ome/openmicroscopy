/*
 * org.openmicroscopy.shoola.agents.datamng.editors.category.CategoryPane
 *
 *------------------------------------------------------------------------------
 *
	...
	extends JPanel
{
	...
	CategoryPane(CategoryEditorManager manager)
	{
	...
	private TableComponent buildTable()
	{
		...
		CategoryData cd = manager.getCategoryData();
	
		//textfields
		nameField = new MultilineLabel(cd.getName());
		...
		descriptionArea = new MultilineLabel(cd.getDescription());
