/*
 * org.openmicroscopy.shoola.agents.treeviewer.cmd.ClassifyChildrenCmd 
 *
 *------------------------------------------------------------------------------
 ...
 * container i.e. dataset or category or by selecting a smart folder.
 *
 ...
 * @since OME3.0
 */
public class ClassifyChildrenCmd
	implements ActionCmd
{
     ...
     */
    public ClassifyChildrenCmd(TreeViewer model)
    {
    ...
    public void execute()
    {
    	...
    	if (node instanceof TreeImageTimeSet) {
    		...
    		Class klass = null;
    		Set<DataObject> s = new HashSet<DataObject>(1);
    		...
    		if (klass != null)
    			model.classifyChildren(klass, s);
    	}
    }
