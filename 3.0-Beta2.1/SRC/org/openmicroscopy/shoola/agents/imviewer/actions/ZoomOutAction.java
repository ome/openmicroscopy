    ...
    extends ViewerAction
{
    ...
    private static final String DESCRIPTION = "Zoom out the image.";
     ...
     */
    public ZoomOutAction(ImViewer model)
    {
        super(model);
        IconManager icons = IconManager.getInstance();
        putValue(Action.SHORT_DESCRIPTION, 
                UIUtilities.formatToolTipText(DESCRIPTION));
        putValue(Action.SMALL_ICON, icons.getIcon(IconManager.ZOOM_OUT));
    }
