...
public class Project implements Serializable {
    ...
    /** full constructor */
    public Project(Integer projectId, String view, String name, String description, org.ome.hibernate.model.Group group, org.ome.hibernate.model.Experimenter experimenter, Set datasets) {
    ...
    /** minimal constructor */
    public Project(Integer projectId, String name, org.ome.hibernate.model.Group group, org.ome.hibernate.model.Experimenter experimenter, Set datasets) {
        this.projectId = projectId;
        this.name = name;
        this.group = group;
        this.experimenter = experimenter;
