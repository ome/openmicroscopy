...
public class Experimenter implements Serializable {
    ...
    /** full constructor */
    public Experimenter(Integer attributeId, String omeName, String email, String firstname, String password, Integer groupId, String dataDir, Integer moduleExecutionId, String lastname, String institution, Set datasets, Set groupsByLeader, Set groupsByContact, Set images, Set projects, Set groups) {
    ...
    /** minimal constructor */
    public Experimenter(Integer attributeId, Set datasets, Set groupsByLeader, Set groupsByContact, Set images, Set projects, Set groups) {
        this.attributeId = attributeId;
        this.datasets = datasets;
        this.groupsByLeader = groupsByLeader;
        this.groupsByContact = groupsByContact;
