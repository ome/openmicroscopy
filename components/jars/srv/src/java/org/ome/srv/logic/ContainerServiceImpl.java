...
import org.ome.model.DatasetWrapper;
...
public class ContainerServiceImpl extends AbstractService implements ContainerService {
	...
	public List retrieveProjectsByExperimenter(LSID experimenterId)
		...
		List lsids = db.evaluateNamedQuery(nq);
		List lsObjects = new ArrayList();
		for (Iterator i = lsids.iterator(); i.hasNext();) {
            LSObject ls = (LSObject) i.next();
            lsObjects.add(db.getLSObject(ls.getLSID()));
        }
	 ...
	 */
	public IProject retrieveProject(LSID lsid)  {
	 ...
	 */
	public IDataset retrieveDataset(LSID lsid)  {
	 ...
	 */
	public List retrieveProjectsByExperimenter(LSID arg0, LSID arg1)  {
	 ...
	 */
	public IProject retrieveProject(LSID arg0, LSID arg1)  {
		// TODO Auto-generated method stub
		/* return null; */
		throw new RuntimeException("implement me");
	}
	 ...
	 */
	public List retrieveDatasetsByExperimenter(LSID arg0, LSID arg1)  {
		// TODO Auto-generated method stub
		/* return null; */
		throw new RuntimeException("implement me");
	}
	 ...
	 */
	public IDataset retrieveDataset(LSID arg0, LSID arg1)  {
		// TODO Auto-generated method stub
		/* return null; */
		throw new RuntimeException("implement me");
	}
	 ...
	 */
	public LSID createProject(IProject arg0)  {
		// TODO Auto-generated method stub
		/* return null; */
		throw new RuntimeException("implement me");
	}
	 ...
	 */
	public LSID createDataset(IDataset arg0)  {
		// TODO Auto-generated method stub
		/* return null; */
		throw new RuntimeException("implement me");
	}
	 ...
	 */
	public void updateDataset(IDataset arg0)  {
		// TODO Auto-generated method stub
		/*  */
		throw new RuntimeException("implement me");
	}
	 ...
	 */
	public List retrieveIDPHierarchy(LSObject[] arg0)  {
		// TODO Auto-generated method stub
		/* return null; */
		throw new RuntimeException("implement me");
	}
