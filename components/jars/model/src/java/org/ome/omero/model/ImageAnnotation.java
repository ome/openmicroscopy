...
public class ImageAnnotation implements Serializable {
    ...
    /** full constructor */
    public ImageAnnotation(Integer attributeId, Integer theT, String content, Integer theC, Integer theZ, Boolean valid, org.ome.omero.model.Image image, org.ome.omero.model.ModuleExecution moduleExecution) {
    ...
    /** minimal constructor */
    public ImageAnnotation(Integer attributeId, org.ome.omero.model.Image image, org.ome.omero.model.ModuleExecution moduleExecution) {
        this.attributeId = attributeId;
        this.image = image;
        this.moduleExecution = moduleExecution;
    }
