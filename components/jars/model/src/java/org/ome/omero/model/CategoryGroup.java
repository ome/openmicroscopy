...
public class CategoryGroup implements Serializable {
    ...
    /** full constructor */
    public CategoryGroup(Integer attributeId, String name, String description, org.ome.omero.model.ModuleExecution moduleExecution) {
    ...
    /** minimal constructor */
    public CategoryGroup(Integer attributeId, org.ome.omero.model.ModuleExecution moduleExecution) {
        this.attributeId = attributeId;
        this.moduleExecution = moduleExecution;
    }
