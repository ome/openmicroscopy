...
public class ImageDimension implements Serializable {
    ...
    /** full constructor */
    public ImageDimension(Integer attributeId, Float pixelSizeC, Float pixelSizeT, Float pixelSizeX, Float pixelSizeY, Float pixelSizeZ, org.ome.omero.model.Image image, org.ome.omero.model.ModuleExecution moduleExecution) {
    ...
    /** minimal constructor */
    public ImageDimension(Integer attributeId, org.ome.omero.model.Image image, org.ome.omero.model.ModuleExecution moduleExecution) {
        this.attributeId = attributeId;
        this.image = image;
        this.moduleExecution = moduleExecution;
    }
