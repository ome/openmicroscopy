...
module omero {
	...
	["ami","amd"] interface MetadataStore extends StatefulServiceInterface
		...
		omero::model::IObject getEnumeration(RString klass, RString value) throws ServerError;
		...
		void setStack(RLong id, Ice::ByteSeq pixels, int theC, int theT) throws ServerError;
		void addImageToDataset(omero::model::Image image, omero::model::Dataset dataset) throws ServerError;
		void addBooleanAnnotationToPixels(omero::model::BooleanAnnotation ba, omero::model::Pixels p) throws ServerError;
		omero::model::Dataset addDataset(RString name, RString description, omero::model::Project project) throws ServerError;
		DatasetList getDatasets(omero::model::Project project) throws ServerError;
		omero::model::Dataset getDataset(long datasetID) throws ServerError;
		omero::model::Project getProject(long projectID) throws ServerError;
		ProjectList getProjects() throws ServerError;
		PixelsList saveToDB() throws ServerError;
		// void setOriginalFiles(File[] files, RString formatRString) throws ServerError;
		// void writeFilesToFileStore(File[] files, long pixelsId) throws ServerError;
		// void populateSHA1(MessageDigest md, Long id) throws ServerError;
		void populateMinMax(RLong id, RInt i) throws ServerError;
		long getRepositorySpace() throws ServerError;
		omero::model::Image getImage(int imageIndex) throws ServerError;
		omero::model::Pixels getPixels(int series) throws ServerError;
		omero::model::Pixels getPixels2(int imageIndex, int pixelsIndex) throws ServerError;
		...
		void setImageInstrumentRef(RInt instrumentRef, int imageIndex) throws ServerError;
		void setImageInstrumentRef2(RString instrumentRef, int imageIndex) throws ServerError;
		...
		omero::model::Instrument getInstrument(int instrumentIndex) throws ServerError;
		...
		omero::model::Laser getLaser(omero::model::Instrument instrument, int lightSourceIndex) throws ServerError;
		...
		omero::model::Arc getArc(omero::model::Instrument instrument, int lightSourceIndex) throws ServerError;
		...
		omero::model::Filament getFilament(omero::model::Instrument instrument, int lightSourceIndex) throws ServerError;
		...
		omero::model::Screen getScreen(int screenIndex) throws ServerError;
		omero::model::Screen addScreen(int screenIndex) throws ServerError;
		...
		omero::model::Plate getPlate(int plateIndex) throws ServerError;
		omero::model::Plate addPlate(int plateIndex) throws ServerError;
		...
		omero::model::Well getWell(int plateIndex, int wellIndex) throws ServerError;
