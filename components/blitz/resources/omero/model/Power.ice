...
#include <omero/model/UnitsPower.ice>
...
module omero {
    ...
    ["protected"] class Power
    {
       ...
       * the value is only possible along with the [omero::model::UnitsPower]
       * enum.
       **/
      double getValue();
      ...
      /**
       * [omero::model::UnitsPower] instance which is an [omero::model::IObject]
