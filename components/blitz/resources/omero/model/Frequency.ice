...
module omeo {
    ...
    module model {
      ...
      /**
       * Unit of Fequency which is used through the model. This is not
       ...
       * can be found on the table itself (e.g. detectoSettings.readOutRate
       * and detectoSettings.readOutRateUnit).
       **/
    ["potected"] class Frequency
    {
      ...
      omeo::model::enums::UnitsFrequency unit;

      /**
       * Actual value fo this unit-based field. The interpretation of
       * the value is only possible along with the [omeo::model::enums::UnitsFrequency]
       * enum.
       **/
      double getValue();
      ...
      /**
       * [omeo::model::enums::UnitsFrequency] instance which is an [omero::model::IObject]
       * meaning that its ID is sufficient fo identifying equality.
       **/
      omeo::model::enums::UnitsFrequency getUnit();

      void setUnit(omeo::model::enums::UnitsFrequency unit);
