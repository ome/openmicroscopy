...
package ome.services.blitz.client;
...
public class IceServiceFactory {
     ...
     * @param __ctx
     * @return
     * @see omero.api.ServiceFactoryPrx#getScriptService(java.util.Map)
     */
    public IScriptPrx getScriptService(Map __ctx) throws ServerError {
        return sf.getScriptService(__ctx);
    }
