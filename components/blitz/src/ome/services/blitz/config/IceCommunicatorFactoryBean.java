...
public class IceCommunicatorFactoryBean extends IceLocalObjectFactoryBean {
    ...
    private final List<Ice.ObjectAdapter> adapters = new ArrayList<Ice.ObjectAdapter>();
    ...
    public void afterPropertiesSet() throws Exception {
        ...
        if (adapterNames != null) {
            for (String name : adapterNames) {
                IceObjectAdapterFactoryBean oaf = (IceObjectAdapterFactoryBean) context
                        .getBean("&" + name);
                oaf.initialize(ic);
