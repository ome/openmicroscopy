...
import omero.api.AMD_IProjection_project;
import omero.api.AMD_IProjection_projectPixels;
import omero.api.AMD_IProjection_projectPlanes;
    ...
    extends AbstractAmdServant implements _IProjectionOperations, BlitzOnly
{
    ...
    public void project_async(AMD_IProjection_project __cb,
            long pixelsId, PixelsType pixelsType, ProjectionType algorithm,
            ProjectionAxis axis, int planeStart, int planeEnd,
            List<Integer> channelList, int stepping,
            int start, int end, String name, Current __current)
        throws ServerError
    {
        callInvokerOnRawArgs(__cb, __current, pixelsId, pixelsType,
                             algorithm.ordinal(), axis.ordinal(), planeStart,
                             planeEnd, channelList, stepping, start, end, name);
    }

    public void projectPlanes_async(AMD_IProjection_projectPlanes __cb,
            long pixelsId, PixelsType pixelsType, ProjectionType algorithm,
            ProjectionAxis axis, int plane, int channelIndex, int stepping,
            int start, int end,
            Current __current) throws ServerError
    {
        callInvokerOnRawArgs(__cb, __current, pixelsId, pixelsType,
                             algorithm.ordinal(), axis.ordinal(),
                             plane, channelIndex, stepping, start, end);
    }
