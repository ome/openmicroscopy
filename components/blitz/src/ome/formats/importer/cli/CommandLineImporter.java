...
public class CommandLineImporter {
    ...
    public static void usage() {
        System.err.println(String.format("\n"
            ...
            + "all valid imports.\n"
            + "\n"
            + "Mandatory session arguments:\n"
            + "  -s SERVER\tOMERO server hostname\n"
            + "  -u USER\tOMERO username\n"
            + "  -w PASSWORD\tOMERO password\n"
            + "  -k KEY\tOMERO session key (can be used in place of -u and -w)\n"
            + "\n"
            + "Naming arguments:\n"
            ...
            + "\n"
            + "Optional arguments:\n"
            + "  -f\t\t\tDisplay the used files and exit (does not require any mandatory session argument)\n"
