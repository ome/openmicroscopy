...
{ 
    ...
    public void setGroup(omero.model.ExperimenterGroup group, Ice.Current current) {
        this.group =  group ;
    ...
    public void setCreationEvent(omero.model.Event creationEvent, Ice.Current current) {
    ...
    public void setUpdateEvent(omero.model.Event updateEvent, Ice.Current current) {
    ...
    public void setPermissions(omero.model.Permissions permissions, Ice.Current current) {
    ...
    public void setExternalInfo(omero.model.ExternalInfo externalInfo, Ice.Current current) {
