 ...
 * methods. The bean captures login params entered by a user after the user
 * clicks the submit button. This way the bean provides a bridge between the JSP
 * page and the application logic.
 * 
...
public class IAdminMyAccountController {
     ...
     * log4j logger
     */
    static Logger logger = Logger.getLogger(IAdminMyAccountController.class
            .getName());
    ...
    /**
     * Confirmation of password. Not-null. Might must pass validation in the
     * security sub-system.
     */
    ...
    /**
     * Provides action for navigation rule "changeMyPassword" what is described
     * in the faces-config.xml file. Changes the password for
     * {@link ome.model.meta.Experimenter}.
     * 
    ...
    /**
     * Provides action for navigation rule "updateMyPassword" what is described
     * in the faces-config.xml file. Changes the password for current
     * {@link ome.model.meta.Experimenter}.
     */
    ...
    /**
     * Gets wrapped {@link ome.model.meta.ExperimenterGroup} for all of the
    ...
    public List getMyGroups() {
        ...
        try {
            ExperimenterGroup[] exg = iadmin.containedMyGroups(this.user
                    .getExperimenter().getId());
    ...
    public String editExperimenter() {
        try {
            this.user = (User) iadmin.getExperimenterById(this.user
                    .getExperimenter().getId());
            return NavigationResults.SUCCESS;
        } catch (Exception e) {
