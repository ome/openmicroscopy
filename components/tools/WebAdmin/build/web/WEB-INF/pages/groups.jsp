...
<c:if test="${sessionScope.LoginBean.mode == true && sessionScope.LoginBean.role == true}">
    <f:view>
        <h:form id="groups">
            ...
            <br/><br/>
            <h:message styleClass="errorText" id="groupsError" for="groups"/><br /> 
            
            <h2><h:outputText value="#{msg.groupsListGroup}" /></h2>
            
            <h:dataTable id="items" value="#{IAGManagerBean.groups}" var="group"  styleClass="list">                
                
                <h:column>
                    <f:facet name="header">
                        <h:outputText value=" #{msg.groupsActions} " />
                    </f:facet>
                    <h:commandLink action="#{IAGManagerBean.delGroup}" onclick="if (!confirm('#{msg.groupsConfirmation}')) return false">
                        <h:graphicImage url="/images/del.png" alt="#{msg.groupsDeleteGroup}"/>
                    </h:commandLink>
                    <h:commandLink action="#{IAGManagerBean.editGroup}">
                        <h:graphicImage url="/images/edit.png" alt="#{msg.groupsEditGroup}"/>
                    </h:commandLink>
                </h:column>
                ...
                <h:column>
                    <f:facet name="header">
                        <h:panelGroup>
                            ...
                            <h:commandLink styleClass="smallLink" action="sortItems" actionListener="#{IAGManagerBean.sortItems}" >
