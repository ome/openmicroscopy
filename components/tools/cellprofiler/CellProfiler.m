    ...
    if isempty(get(handles.OutputFileNameEditBox,'string'))
        ...
        if ~exist(handles.Current.DefaultImageDirectory, 'dir')
            ...
            DetailButton=uicontrol('Style','pushbutton','String','Details','Position',[280 30 60 25],'FontName','Helvetica','FontSize',handles.Preferences.FontSize,...
                ...
                'uicontrol(DetWin, ''Tag'', ''DetailWindowText'', ''Style'', ''text'', ''Position'', [10 DetWinheight-30-13*(TimerData.NumberOfModules+7) 78 13*(TimerData.NumberOfModules+7)],', ...
                '''HorizontalAlignment'', ''left'', ''BackgroundColor'', [0.7 0.7 0.9], ''FontSize'', TimerData.FontSize,', ...
                '''String'', ModuleStr);',...
                'else,',...
                'figure(DetWin);',...
                ...
                'else,',...
                'uicontrol(DetWin, ''Tag'', ''Time1stCycle'', ''Style'', ''text'', ''Position'', [100 DetWinheight-30-13*(TimerData.NumberOfModules+7) 51 13*(TimerData.NumberOfModules+7)],', ...
                '''HorizontalAlignment'', ''center'', ''BackgroundColor'', [0.7 0.7 0.9], ''FontSize'', TimerData.FontSize,', ...
                ...
                'else,',...
                'uicontrol(DetWin, ''Tag'', ''TimeAvgOthers'', ''Style'', ''text'', ''Position'', [160 DetWinheight-30-13*(TimerData.NumberOfModules+7) 63 13*(TimerData.NumberOfModules+7)],', ...
                '''HorizontalAlignment'', ''center'', ''BackgroundColor'', [0.7 0.7 0.9], ''FontSize'', TimerData.FontSize,', ...
...
elseif strcmp(ImageDataOrHelp,'Help')
    ...
    TextString = sprintf('CellProfiler version 1.0.4942\n\nPlease choose specific help below:');
