...
MSG_AZEXIT="Exit from importer complete"
MSG_TERMINATED="importer TERMINATED."
...
def look_for_java():
	...
	for JAVADIR in JAVA_CHECK_DIRS.split():
		IFS=$'\n'
