...
""",
      ...
      package_dir = {"": "target"},
      packages=['', 'xmlrunner', 'omero', 'omero.plugins','omero.api','omero.install','omero.model','omero.sys','omero.util','omero.romio','omero_ext','omero.gateway','omero.gateway.scripts', 'omero.fs'],
