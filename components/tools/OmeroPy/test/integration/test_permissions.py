...
class TestPermissions(lib.ITest):
    ...
    def testOGContextParameter(self):
        ...
        class F(CallContextFixture):
            ...
            def get_image(this, query):
                rv = query.get("Image", this.img.id.val, {"omero.group": "-1"})
                return rv
    ...
    def testOGSetImplicitContext(self):
        ...
        class F(CallContextFixture):
            ...
            def prepare(this):
                rv = this.client.getImplicitContext().put("omero.group", "-1")
                return rv
        F(self).assertCallContext()
    ...
    def testOGSetSecurityContext(self):
        ...
        class F(CallContextFixture):
            ...
            def prepare(this):
                rv = this.sf.setSecurityContext(ExperimenterGroupI(-1, False))
                return rv
