...
"""
   Integration tests for tickets upto 999.
...
class TestTicket1000(lib.ITest):
    ...
    # This overridden test has been commented out just in case it serves
    # some documentation process
    #
    # This test is overridden by the next but would fail anyway due to null
    # params
    # def test880(self):
    ...
    #         """select i from Image i where i.name ilike '%h%' """, prms)
