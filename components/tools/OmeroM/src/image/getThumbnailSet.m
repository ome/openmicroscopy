...
%
%   thumbnails = getThumbnail(session, images) returns a set of thumbnails
%   from a series of input images.
%
%   thumbnails = getThumbnail(session, images, width, height) also sets the
%   width and the height of the thumbnails. 
%
%   thumbnails = getThumbnail(session, imageIDs) returns a set of 
%   thumbnails from a series of input image identifiers.
%
%   thumbnails = getThumbnail(session, imageIDs,  width, height) also sets
