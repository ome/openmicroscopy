function deleteDatasets(session, varargin)
...
%   Examples:
%
%      deleteDatasets(session, ids);
%
% See also: DELETEOBJECTS, DELETEPROJECTS, DELETEIMAGES
...
deleteObjects(session, ip.Results.ids, 'dataset');