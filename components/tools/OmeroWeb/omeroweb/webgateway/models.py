...
#    rv = omero.client_wrapper(self.username, self.password, self, group=trysuper and str(self.admin_group) or None,try_super=trysuper, extra_config=self.config_file)
#    rv.conn = self
#    return rv
#
