...
urlpatterns = patterns(
    ...
    url(r'^forgottenpassword/$',
        views.forgotten_password, name="waforgottenpassword"),
    ...
    url(r'^change_password/(?P<eid>[0-9]+)/$',
        views.manage_password, name="wamanagechangepasswordid"),
    url(r'^groups/$', views.groups, name="wagroups"),
    url(r'^group/(?P<action>((?i)new|create|edit|save))/' +
        r'(?:(?P<gid>[0-9]+)/)?$',
        views.manage_group, name="wamanagegroupid"),
    ...
    url(r'^drivespace/$',
        views.drivespace, {'template': 'json'}, name="wadrivespace"),
