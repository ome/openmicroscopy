...
urlpatterns = patterns('',
    ...
    url( r'^drivespace_json/groups/$', views.drivespace_json, {'query': 'groups'}, name="waloaddrivespace_groups"),
    url( r'^drivespace_json/users/$', views.drivespace_json, {'query': 'users'}, name="waloaddrivespace_users"),
    url( r'^drivespace_json/group/(?P<groupId>[0-9]+)/$', views.drivespace_json, name="waloaddrivespace_group"),
    url( r'^drivespace_json/user/(?P<userId>[0-9]+)/$', views.drivespace_json, name="waloaddrivespace_user"),
    ...
    url( r'^noemail/$', views.NoEmailView.as_view(), name="wanoemail"),
)
