...
CUSTOM_SETTINGS_MAPPINGS = {
    ...
    "omero.web.caches":
        ["CACHES",
         '{"default": {"BACKEND":'
         ' "django.core.cache.backends.dummy.DummyCache"}}', json.loads,
    ...
    "omero.web.admins":
        ["ADMINS",
         ...
         " Each member of the tuple should be a tuple of (Full name, email"
         " address)."],
    "omero.web.server_email":
        ["SERVER_EMAIL",
         None, identity,
         "The email address that error messages come from, such as those sent"
         " to :property:`omero.web.admins`.  Requires EMAIL properties"
         " below."],
    ...
    "omero.web.scripts_to_ignore": [
        ...
        '"/omero/import_scripts/Populate_ROI.py"]', parse_paths, None],
