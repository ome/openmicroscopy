...
urlpatterns = patterns('',
    ...
    ( r'(?i)^mydata/(?P<o1_type>((?i)orphaned|ajaxorphaned))/$', views.manage_my_data ),
    ...
    ( r'(?i)^userdata/(?P<o1_type>((?i)orphaned|ajaxorphaned))/$', views.manage_user_containers ),
    ...
    #( r'(?i)^groupdata/(?P<o1_type>((?i)orphaned|ajaxorphaned))/$', views.manage_group_containers ),
    ...
    ( r'(?i)^tag/([0-9]+)/([0-9]+)/([0-9]+)/([0-9]+)/$', views.manage_data_by_tag ),
    ( r'(?i)^tag/([0-9]+)/([0-9]+)/([0-9]+)/([0-9]+)/([0-9]+)/$', views.manage_data_by_tag ),
    ...
    ( r'(?i)^render_thumbnail/size/(?P<size>[0-9]+)/(?P<iid>[0-9]+)/$', views.render_thumbnail_resize ),
    ( r'(?i)^render_thumbnail/size/(?P<size>[0-9]+)/(?P<iid>[0-9]+)/(?P<share_id>[0-9]+)/$', views.render_thumbnail_resize ),
    ...
    ( r'(?i)^share_owner_content/([0-9]+)/$', views.load_share_owner_content ),
    ...
    (r'(?i)^render_image/(?P<iid>[0-9]+)/(?P<z>[0-9]+)/(?P<t>[0-9]+)/(?P<share_id>[0-9]+)/$', views.render_image),
    (r'(?i)^img_detail/(?P<iid>[0-9]+)/(?:(?P<share_id>[0-9]+)/)?$', views.image_viewer),
    (r'(?i)^imgData/(?P<iid>[0-9]+)/$', views.imageData_json),
    (r'(?i)^imgData/(?P<iid>[0-9]+)/(?P<share_id>[0-9]+)/$', views.imageData_json),
