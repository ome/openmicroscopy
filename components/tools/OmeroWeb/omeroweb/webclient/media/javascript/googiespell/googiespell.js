...
GoogieSpell.prototype.showErrorWindow = function(elm, id) {
    ...
    if(!changed) {
        ...
        var ok_pic = AJS.IMG({'src': '/webclient/static/images/googiespell/ok.gif', 'style': 'width: 32px; height: 16px; margin-left: 2px; margin-right: 2px; cursor: pointer;'});
...
GoogieSpell.prototype.createChangeLangPic = function() {
    var img = AJS.IMG({'src': '/webclient/static/images/googiespell/change_lang.gif', 'alt': "Change language"});
...
GoogieSpell.prototype.createSpellDiv = function() {
    ...
    if(this.show_spell_img)
        spell_img = AJS.IMG({'src': '/webclient/static/images/googiespell/spellc.gif'});
...
GoogieSpell.prototype.flashNoSpellingErrorState = function(on_finish) {
    ...
    if(this.main_controller) {
        ...
        var dummy = AJS.IMG({'src': '/webclient/static/images/googiespell/blank.gif', 'style': 'height: 16px; width: 1px;'});
        var rsm = AJS.SPAN();
...
GoogieSpell.prototype.appendIndicator = function(elm) {
    var img = AJS.IMG({'src': '/webclient/static/images/googiespell/indicator.gif', 'style': 'margin-right: 5px;'});
    AJS.setWidth(img, 16);
