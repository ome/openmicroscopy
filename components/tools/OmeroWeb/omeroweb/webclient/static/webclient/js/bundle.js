...
/***/ function(module, exports, __webpack_require__) {
	...
	var _CentrePanel = __webpack_require__(159);

	var _CentrePanel2 = _interopRequireDefault(_CentrePanel);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	function renderCentrePanel(jstree, selected) {
	    console.log("renderCentrePanel...");
	    _reactDom2.default.render(_react2.default.createElement(_CentrePanel2.default, {
	        jstree: jstree,
	        selected: selected }), document.getElementById('content_details'));
	}

	exports.default = renderCentrePanel;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _IconTableFooter = __webpack_require__(160);

	var _IconTableFooter2 = _interopRequireDefault(_IconTableFooter);

	var _IconTable = __webpack_require__(161);

	var _IconTable2 = _interopRequireDefault(_IconTable);

	var _PlateManager = __webpack_require__(164);

	var _PlateManager2 = _interopRequireDefault(_PlateManager);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var CentrePanel = _react2.default.createClass({
	    displayName: 'CentrePanel',
	    ...
	    setIconSize: function setIconSize(size) {
	        this.setState({ iconSize: size });
	    },

	    renderNothing: function renderNothing(selected) {
	    ...
	    getParentNode: function getParentNode(selected, inst) {
	    ...
	    render: function render() {
	        ...
	        if (parentNode) {
	            ...
	            if (dtype === "plate" || dtype === "acquisition") {
	                ...
	                iconTable = _react2.default.createElement(_PlateManager2.default, {
	                    plateId: plateId,
	                ...
	                iconTable = _react2.default.createElement(_IconTable2.default, {
	                    parentNode: parentNode,
	                    inst: inst,
	        ...
	        return _react2.default.createElement(
	            ...
	            null,
	            iconTable,
	            _react2.default.createElement(_IconTableFooter2.default, {
	                iconSize: this.state.iconSize,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var IconTableFooter = _react2.default.createClass({
	    displayName: "IconTableFooter",
	    ...
	    render: function render() {
	        return _react2.default.createElement(
	            "div",
	            { className: "toolbar iconTableFooter" },
	...
	exports.default = IconTableFooter;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _IconTableHeader = __webpack_require__(162);

	var _IconTableHeader2 = _interopRequireDefault(_IconTableHeader);

	var _ImageIcon = __webpack_require__(163);
	...
	var IconTable = _react2.default.createClass({
	    ...
	    handleIconClick: function handleIconClick(imageId, event) {
	        var inst = this.props.inst;
	        var containerNode = OME.getTreeImageContainerBestGuess(imageId);
	        var selectedNode = inst.locate_node('image-' + imageId, containerNode)[0];
	        var keys = {
	    ...
	    render: function render() {
	        ...
	        return _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	                'div',
	                { id: 'icon_table', className: 'iconTable' },
	                _react2.default.createElement(
	                    'ul',
	                    { id: 'dataIcons',
	                        ref: 'dataIcons',
	...
	var IconTableHeadRow = _react2.default.createClass({
	    displayName: 'IconTableHeadRow',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var IconTableHeader = _react2.default.createClass({
	    displayName: 'IconTableHeader',

	    handleLayoutClick: function handleLayoutClick(event) {
	    ...
	    render: function render() {
	        ...
	        return _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	                'form',
	                { className: 'search filtersearch', id: 'filtersearch', action: '#', style: { top: 4 } },
	                _react2.default.createElement(
	                    'div',
	                    null,
	...
	exports.default = IconTableHeader;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Plate = __webpack_require__(165);

	var _Plate2 = _interopRequireDefault(_Plate);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var PlateManager = _react2.default.createClass({
	    displayName: 'PlateManager',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _PlateGrid = __webpack_require__(166);

	var _PlateGrid2 = _interopRequireDefault(_PlateGrid);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var Plate = _react2.default.createClass({
	    displayName: 'Plate',
	    ...
	    handleFieldSelect: function handleFieldSelect(event) {
	    ...
	    render: function render() {
	        ...
	        for (var f = fields[0], idx = 1; f <= fields[1]; f++) {
	            fieldSelect.push(_react2.default.createElement(
	                'option',
	                {
	                    key: f,
	                    value: f },
	        ...
	        return _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	                'div',
	                { id: 'spw' },
	                _react2.default.createElement(_PlateGrid2.default, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Well = __webpack_require__(167);
	...
	var PlateGrid = _react2.default.createClass({
	    ...
	    getWellIdsFromUrlQuery: function getWellIdsFromUrlQuery(data) {
	    ...
	    getWellId: function getWellId(data, wellId, imageId) {
	        var wId;
	        ...
	        var rows = data.rowlabels.map(function (r, rowIndex) {
	            var wells = data.collabels.map(function (c, colIndex) {
	                ...
	                if (well) {
	                    ...
	                    return _react2.default.createElement(
	                        'td',
	                        { className: 'placeholder', key: r + "_" + c },
