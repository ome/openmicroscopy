	...
	extends JPanel
{
	...
	public void setController(UsersTabController controller)
	{
		...
		addToGroupBtn.addActionListener(new GroupAction(GroupAction.ADD, controller));
		removeFromGroupBtn.addActionListener(new GroupAction(GroupAction.REMOVE, controller));
	...
	void buildUI()
	{
		...
		userDataEntryPanel.setLayout(new BoxLayout(userDataEntryPanel, BoxLayout.Y_AXIS));
		...
		userGroupButtonPanel.setLayout(new BoxLayout(userGroupButtonPanel, BoxLayout.Y_AXIS));
		...
		userGroupListPanel.setLayout(new BoxLayout(userGroupListPanel, BoxLayout.Y_AXIS));
		...
		userGroupPanel.setLayout(new BoxLayout(userGroupPanel, BoxLayout.X_AXIS));
		...
		groupListPanel.setLayout(new BoxLayout(groupListPanel, BoxLayout.X_AXIS));
		...
		userListButtonPanel.setLayout(new BoxLayout(userListButtonPanel, BoxLayout.Y_AXIS));
