...
public class GroupsTabController 
	implements UserListController, GroupListController
{
	private			Model 		model;
	...
	public void addUser()
	{
		try
		{
			...
			{
				view.showErrorMessage("Please select the group you wish add to user.");
				return;
			}
	...
	public void removeUser()
	{
		try
		{
			...
			if(groupSelected==null)
			{
				view.showErrorMessage("Please select a group to remove from user.");
				return;
			}
