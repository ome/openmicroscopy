...
public class CommentMessenger extends JDialog implements ActionListener {
    ...
    public CommentMessenger(JFrame owner, String title, Boolean modal) {
        ...
        sendBtn = gui.addButton(mainPanel, "Send", 'S',
                "Send your comment to the development team", "3, 1, f, c",
                debug);
        ...
        String message = "Thank you for taking the time to send us your comments. \n\n"
                ...
                + "OMERO and improve our software. Any personal details you provide are"
        ...
        emailTextField = gui.addTextField(commentPanel, "Email: ", emailText,
                'E', "Input tyour email address here.", "(Optional)",
