	...
	implements ActionListener
{
	...
	void createUIElements()
	{
		...
		exceptionDetailPane.setBorder(BorderFactory.createLineBorder(
												new Color(83, 134, 219), 2));
		exceptionTextPane.setBorder(BorderFactory.createLineBorder(
												new Color(83, 134, 219), 2));
		operationTextPane.setBorder(BorderFactory.createLineBorder(
												new Color(83, 134, 219), 2));
