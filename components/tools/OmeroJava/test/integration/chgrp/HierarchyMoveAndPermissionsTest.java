	...
	extends AbstractTest
{
    ...
    /**
     * Test to move an image w/o pixels between 2 <code>RW----</code> groups.
     * The image is moved by the administrator who is not member of
     * the source/destination group.
     * @throws Exception Thrown if an error occurred.
     */
    @Test
    public void testMoveBasicImageByAdmin()
	throws Exception
    {
	String perms = "rw----";
	//new user
     ...
     * <code>RW----</code> group.
     * The owner of the image creates the link with another user's dataset.
     * Attempt to move the dataset.
     * None of the users are owner of the groups. Only the first user is
     ...
     * The owner of the image creates the link with another user's dataset.
     * Attempt to move the dataset.
     * None of the users are owner of the groups. Both users are members of
     * destination group.
     * @throws Exception Thrown if an error occurred.
     */
    @Test
    ...
    /**
     * Test to move an image w/o pixels owned by another user between
     * 2 <code>RWRW--</code>groups. 2 users,
     * user 1 owner of an image.
     * user 2 is not.
     * User 2 tries to move the image.
     * Both user1 and user2 are members of the target group but user2 not
     * owner of the group.
     * @throws Exception Thrown if an error occurred.
     */
    @Test
