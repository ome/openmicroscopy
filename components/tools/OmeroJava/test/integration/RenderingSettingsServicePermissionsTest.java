	...
	extends AbstractServerTest
{
	 ...
	 * @param role The role of the user. The user can be the group owner, and 
	 * administrator or a group member.
	 * @throws Exception Thrown if an error occurred.
	 */
	private void saveSettingsOtherUserImage(String permissions,
			int role)
	throws Exception 
	{
		EventContext ctx = newUserAndGroup(permissions);
		...
		prx.setOriginalSettingsInSet(Image.class.getName(), Arrays.asList(
	 ...
	 * @throws Exception Thrown if an error occurred.
	 */
	private void applySettingsToSetSourcetImageViewedByOther(String permissions,
			int role)
	throws Exception 
	{
		EventContext ctx = newUserAndGroup(permissions);
	 ...
	 * modified.
	 * 
	 * @param initial The initial permissions.
	 * @param modified The modified permissions.
	 * @throws Exception
	 */
     ...
     */
    @Test
    public void testApplySettingsToSetForImageByGroupOwnerRW()
    	throws Exception 
    {
     ...
     */
    @Test
    public void testApplySettingsToSetForImageByAdminOwnerRW()
    	throws Exception 
    {
     ...
     */
    @Test
    public void testApplySettingsToSetForImageByAdminRWR()
    	throws Exception 
    {
     ...
     */
    @Test
    public void testApplySettingsToSetForImageByMemberRWR()
    	throws Exception 
    {
     ...
     */
    @Test
    public void testApplySettingsToSetForImageByAdminRWRA()
    	throws Exception 
    {
     ...
     */
    @Test
    public void testApplySettingsToSetForImageByMemberRWRA()
    	throws Exception 
    {
     ...
     */
    @Test
    public void testApplySettingsToSetForImageByAdminRWRW()
    	throws Exception 
    {
     ...
     */
    @Test
    public void testApplySettingsToSetForImageByMemberRWRW()
    	throws Exception 
    {
    ...
    /**
     * Tests to apply the rendering settings to a collection of images
     * The group is initially <code>RWRA--</code> and then <code>RWR---</code>.
     * @throws Exception Thrown if an error occurred.
     */
    @Test
    ...
    /**
     * Tests to apply the rendering settings to a collection of images
     * The group is initially <code>RWR---</code> and then <code>RW----</code>.
     * @throws Exception Thrown if an error occurred.
     */
    @Test
    ...
    /**
     * Tests to apply the rendering settings to a collection of images
     * The group is initially <code>RWRA--</code> and then <code>RW----</code>.
     * @throws Exception Thrown if an error occurred.
     */
    @Test
    ...
    /**
     * Tests to apply the rendering settings to a collection of images
     * The group is initially <code>RWRW--</code> and then <code>RW----</code>.
     * @throws Exception Thrown if an error occurred.
     */
    @Test
     ...
     */
    @Test
    public void testSaveSettingsImageOtherUserByAdminRWRW()
    	throws Exception 
    {
     ...
     */
    @Test
    public void testSaveSettingsImageOtherUserByMemberRWRW()
    	throws Exception 
    {
     ...
     */
    @Test
    public void testSaveSettingsImageOtherUserByAdminRWRA()
    	throws Exception 
    {
     ...
     */
    @Test
    public void testSaveSettingsImageOtherUserByMemberRWRA()
    	throws Exception 
    {
     ...
     */
    @Test
    public void testSaveSettingsImageOtherUserByAdminRWR()
    	throws Exception 
    {
