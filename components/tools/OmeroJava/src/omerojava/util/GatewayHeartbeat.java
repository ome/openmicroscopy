/*
* ome.services.blitz.gateway.services.util.GatewayHeartbeat
*
 *------------------------------------------------------------------------------
...
{
	/** The gateway object that the OmeroJava client will wrap. */
	private GatewayPrx gateway;

	/** Heartbeat service and keep alive thread. */
	...
	class HeartBeatService
	{
		...
		public void start()
		{
			...
			final ScheduledFuture<?> beatHandle=
					scheduler.scheduleAtFixedRate(beat, 10, 10,
