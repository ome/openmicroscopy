/*
 * ome.adapters.pojos.PojoHierarchyBrowsingAdapter
 *
 *------------------------------------------------------------------------------
 *
...
public class PojoHierarchyBrowsingAdapter implements PojoOmeroService {
    ...
    /* (non-Javadoc)
     * @see ome.adapters.pojos.PojoOmeroService#loadPDIHierarchy(java.lang.Class, int)
     */
    ...
    /* (non-Javadoc)
     * @see ome.adapters.pojos.PojoOmeroService#loadCGCIHierarchy(java.lang.Class, int)
     */
    ...
    /* (non-Javadoc)
     * @see ome.adapters.pojos.PojoOmeroService#findPDIHierarchies(java.util.Set)
     */
    ...
    /* (non-Javadoc)
     * @see ome.adapters.pojos.PojoOmeroService#findCGCIHierarchies(java.util.Set)
     */
    ...
    /* (non-Javadoc)
     * @see ome.adapters.pojos.PojoOmeroService#findImageAnnotations(java.util.Set)
     */
    ...
    /* (non-Javadoc)
     * @see ome.adapters.pojos.PojoOmeroService#findAnnotations(java.lang.Class, java.util.Set, int)
     */
