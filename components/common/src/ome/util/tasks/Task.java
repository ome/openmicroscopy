 ...
 * in a {@link Thread} for execution. The {@link Runnable#run()} method, however,
 * has been marked final and instead other {@link Task} methods must be
 * overwritten.
 * 
 ...
 * remain false and execution will be passed to {@link #handleException(RuntimeException)}.
 * Finally, {@link #close()} is called. Subclasses should most likely check
 * the value of {@link #completedSuccessfully()} before attempting {@link #close()};
 * 
...
public abstract class Task implements Runnable
{
	 ...
	 * 
	 * @param serviceFactory Cannot be null.
	 * @param properties Context variables for the task. Optional (can be null).
	 */
	...
	/**
	 * Performs the actual work of the {@link Task}. Execution takes place in
	 * a try/catch/finally-block, and subclasses can throw any 
	 ...
	 * @param e Any enumeration. May not be null.
	 */
	protected String enumValue(Enum e) {
		if (e == null) throw new ApiUsageException("Enum cannot be null.");
