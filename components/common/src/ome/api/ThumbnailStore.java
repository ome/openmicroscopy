...
public interface ThumbnailStore extends StatefulServiceInterface
{
     ...
     * @param pixelsId an {@link ome.model.core.Pixels} id.
     * @throws ApiUsageException if no pixels object exists with the ID
     * <i>pixelsId</i>.
     */
     ...
     * <code>null</code>.
     * @param renderingDefId an {@link ome.model.display.RenderingDef} id. 
     * <code>null</code> specifies the user's currently active rendering
     * settings to be used.
     * @throws ApiUsageException if no rendering definition exists with the ID
     * <i>renderingDefId</i>.
     */
