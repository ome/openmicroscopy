...
public class ChannelComponent implements Serializable {
    ...
    /** full constructor */
    public ChannelComponent(Integer attributeId, Integer pixelsId, Integer index, String colorDomain, Integer logicalChannel, org.ome.omero.model.Image image, org.ome.omero.model.ModuleExecution moduleExecution) {
    ...
    /** minimal constructor */
    public ChannelComponent(Integer attributeId, org.ome.omero.model.Image image, org.ome.omero.model.ModuleExecution moduleExecution) {
        this.attributeId = attributeId;
        this.image = image;
        this.moduleExecution = moduleExecution;
    }
