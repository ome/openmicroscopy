...
/**
 * A task object to render a wavelength asynchronously. This task is used by the
 * {@link RGBStrategy} to do concurrent rendering if more than one wavelength
 * has to be processed.
 * 
 ...
 *          2005/06/16 17:31:27 $) </small>
 * @since OME2.2
 */
class RenderRGBWaveTask implements RenderingTask {
    ...
    /**
     * The alpha component of the color used when mapping a quantized value onto
     * the color space.
     */
    private int alpha;
     ...
     *            The wavelength data.
     * @param qs
     *            The quantum strategy associated to the wavelength.
     * @param cc
     *            The spatial transformations to apply to the quantized data.
     * @param alpha
     *            The alpha component to apply to the final image.
     * @param sizeX1
     *            The number of pixels along the <i>X1</i>-axis.
     * @param sizeX2
     *            The number of pixels along the <i>X2</i>-axis.
