/*
 * omeis.providers.re.data.FloatConverter
 *
 *------------------------------------------------------------------------------
 *
...
/** 
 * Packs a sequence of bytes representing float into a double value. 
 * This class handles the conversion of a floating-point value stored according
 * to the <i>IEEE 754</i> floating-point "single format" bit layout.
 *
