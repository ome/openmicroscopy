/*
 * omeis.providers.re.data.DoubleConverter
 *
 *------------------------------------------------------------------------------
 *
...
/** 
 * Packs a sequence of bytes representing double into a double value. 
 * This class handles the conversion of a floating-point value stored according
 * to the <i>IEEE 754</i> floating-point "double format" bit layout.
 *
