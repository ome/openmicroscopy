/*
 * omeis.providers.re.data.IntBEConverter
 *
 *------------------------------------------------------------------------------
 *
 ...
 * big-endian integer into a double value. 
 * This class handles the conversion of  signed big-endian integers of 
 * <code>1, 2</code> and <code>4</code>-byte length (bytes are assumed to 
 * be <code>8</code>-bit long).
 *
