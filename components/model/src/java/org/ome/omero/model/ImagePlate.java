...
public class ImagePlate implements Serializable {
    ...
    /** full constructor */
    public ImagePlate(Integer attributeId, String well, Integer sample, Integer plate, org.ome.omero.model.Image image, org.ome.omero.model.ModuleExecution moduleExecution) {
    ...
    /** minimal constructor */
    public ImagePlate(Integer attributeId, org.ome.omero.model.Image image, org.ome.omero.model.ModuleExecution moduleExecution) {
        this.attributeId = attributeId;
        this.image = image;
        this.moduleExecution = moduleExecution;
    }
