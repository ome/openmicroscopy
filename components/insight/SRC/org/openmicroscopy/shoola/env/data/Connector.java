...
class Connector
{
	...
	/**
	 * Shuts down the rendering service.
	 * 
	 * @param pixelsID The id to handle.
	 */
	void shutDownRendering(long pixelsID)
	{
		StatefulServiceInterfacePrx svc = reServices.get(pixelsID);
		if (svc != null) {
			closeService(svc);
