...
public class OpenActivityParam
{
    ...
    /** The objects to open. */
    private Collection<pojos.DataObject> objects;
     ...
     * @param folderPath The location where to load the data if required.
     */
    public OpenActivityParam(ApplicationData application,
            pojos.DataObject object, String folderPath)
    {
        this.application = application;
        objects = new ArrayList<pojos.DataObject>();
     ...
     */
    public OpenActivityParam(ApplicationData application,
            Collection<pojos.DataObject> objects, String folderPath)
    {
        this.application = application;
    ...
    /**
     * Returns the objects to open.
     *
     * @return See above.
     */
    public Collection<pojos.DataObject> getObjects() { return objects; }
