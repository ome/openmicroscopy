/*
 * org.openmicroscopy.shoola.util.ui.border.SeparatorOneLineBorder 
 *
 *------------------------------------------------------------------------------
...
/** 
 * Used to replace <code>JSeparator</code>.
 *
 ...
 * @since 3.0-Beta4
 */
public class SeparatorOneLineBorder
	extends OneLineBorder
{
	...
	{
		super(TOP, DEFAULT_COLOR, DEFAULT_THICKNESS);
	}
