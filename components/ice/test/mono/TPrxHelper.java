...
public final class TPrxHelper extends Ice.ObjectPrxHelperBase implements TPrx {
    ...
    public static TPrx checkedCast(Ice.ObjectPrx b) {
        TPrx d = null;
        if (b != null) {
            try {
                d = (TPrx) b;
    ...
    public static TPrx checkedCast(Ice.ObjectPrx b, java.util.Map ctx) {
        TPrx d = null;
        if (b != null) {
            try {
                d = (TPrx) b;
    ...
    public static TPrx checkedCast(Ice.ObjectPrx b, String f) {
        TPrx d = null;
        if (b != null) {
    ...
    public static TPrx checkedCast(Ice.ObjectPrx b, String f, java.util.Map ctx) {
        TPrx d = null;
        if (b != null) {
            Ice.ObjectPrx bb = b.ice_newFacet(f);
            try {
    ...
    public static TPrx uncheckedCast(Ice.ObjectPrx b) {
        TPrx d = null;
        if (b != null) {
            TPrxHelper h = new TPrxHelper();
            h.__copyFrom(b);
    ...
    public static TPrx uncheckedCast(Ice.ObjectPrx b, String f) {
        TPrx d = null;
        if (b != null) {
            Ice.ObjectPrx bb = b.ice_newFacet(f);
            TPrxHelper h = new TPrxHelper();
    ...
    public static void __write(IceInternal.BasicStream __os, TPrx v) {
        __os.writeProxy(v);
    }

    public static TPrx __read(IceInternal.BasicStream __is) {
