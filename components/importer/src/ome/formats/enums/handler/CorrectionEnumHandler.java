...
class CorrectionEnumHandler implements EnumerationHandler
{
	...
	static final Class<? extends IEnum> HANDLER_FOR = Correction.class;
	 ...
	 */
	public IEnum findEnumeration(HashMap<String, IEnum> enumerations,
			                     String value)
	{
		for (PatternSet x : searchPatterns)
		{
			...
			{
				IEnum enumeration = enumerations.get(x.value);
				if (enumeration == null)
				{
