 ...
 * OMERO services such as IQuery and IEnum and to provide a consistent, server
...
public interface EnumerationProvider
{
     ...
     */
    IEnum getEnumeration(Class<? extends IEnum> klass, String value,
    		               boolean loaded);
     ...
     * @return Enumeration object.
     */
    HashMap<String, IEnum> getEnumerations(Class<? extends IEnum> klass);
}
