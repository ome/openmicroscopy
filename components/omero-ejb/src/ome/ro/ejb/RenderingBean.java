...
public class RenderingBean extends AbstractBean implements RenderingEngine
{
    ...
    {
        super();
        pixMetaSrv = (IPixels) ctx.getBean("pixelsMetadataService");
        pixDataSrv = (PixelsService) ctx.getBean("pixelsDataService");
        // TODO use class name. 
    }

    public  RenderingBean(IPixels metaService, 
            PixelsService dataService)
    {
