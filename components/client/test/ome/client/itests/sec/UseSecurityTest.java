...
public class UseSecurityTest extends AbstractPermissionsTest {
    ...
    protected void imagePixels(ServiceFactory sf, boolean can_change_img,
        ...
        // https://trac.openmicroscopy.org.uk/ome/ticket/357
    ...
    // https://trac.openmicroscopy.org.uk/ome/ticket/366
    // =========================================================================
    ...
    public void test_RootCantOverride() throws Exception {
        ...
        // https://trac.openmicroscopy.org.uk/ome/changeset/944
        // https://trac.openmicroscopy.org.uk/ome/ticket/337
        reacquire(r);
