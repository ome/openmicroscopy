...
public abstract class AbstractPermissionsTest extends AbstractSecurityTest {
    ...
    final static protected Permissions RW_RW_RW = new Permissions(),
            RW_RW_xx = new Permissions().revoke(WORLD, READ, WRITE),
            RW_xx_xx = new Permissions().revoke(WORLD, READ, WRITE).revoke(
    ...
    protected ExperimenterGroup system_group = new ExperimenterGroup(0L, false),
            common_group = new ExperimenterGroup(),
            user_other_group = new ExperimenterGroup();

    protected Experimenter root = new Experimenter(0L, false),
            pi = new Experimenter(), user = new Experimenter(),
            other = new Experimenter(), world = new Experimenter();
