...
public class UseCasesTest extends AbstractTest {
    ...
    @Test
    public void test_agentDeletesAnEntityAndUpdateIsRegistered()
            throws Exception {
        //
        // Mock setup
        //
    ...
    private void updateReturnsSingleNewProject() {
        serviceFactory.mockUpdate = updateMockForFlush(updatedProjectArray(),
                null);
    }

    private void updateReturnsSingleUpdatedProject() {
        serviceFactory.mockUpdate = updateMockForFlush(null,
                updatedProjectArray());
    }
