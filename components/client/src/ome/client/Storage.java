...
public class Storage {
     ...
     * 
     * @return The keys of the map (i.e. transient entities) are returned.
     */
    ...
    /**
     * is entity scheduled for creation. Here the <em>key</em> of the map is
     * checked
     */
    ...
    /**
     * does entity have a replacement. Null and non-transient objects are
    ...
    /**
     * returns the replacement for this transient object. This must be set by
     * {@link #replaceTransient(IObject, IObject)}
     * 
     * @param iObject
     * @return replacement entity. May be null. Test with
