...
/**
 * strategy interface which handles version conflicts during registering of
 * entities.
 * 
 * @author <br>
 *         Josh Moore &nbsp;&nbsp;&nbsp;&nbsp; <a
...
public interface ConflictResolver {
     ...
     *            entity which is to be considered for replacement
     * @return the entity which is to be used. This may be either of the
     *         existing objects or possibly a newly created one.
     * @throws ConcurrentModificationException
     *             this is a possible backdoor if a decision cannot or should
     *             not be made, and is in fact the default strategy.
     */
    IObject resolveConflict(IObject registeredVersion,
