...
/**
 * A replacement for the AquaFileChooserUI. Provides a column view similar to
 * the one provided with the native Aqua user interface on Mac OS X 10.3
 * (Panther).
 * 
 * @author Werner Randelshofer
 * @version 1.7 2006-04-08 Use BasicFileView when UIManager property
 *          FileChooser.speed is set to true. <br>
 *          1.6.6 2006-03-28 Update approve button state on text change in
 *          filename field. <br>
 *          1.6.5 2006-03-22 New folder was created in parent directory when a
 *          folder was selected. <br>
 *          1.6.4 2006-03-15 Couldn't save a new file. <br>
 *          1.6.3 2006-03-14 Name of non-existing file was not written into
 *          filename field. <br>
 *          1.6.2 2006-03-05 Approve button did not work properly for multiple
 *          selection. Disallow approval on double clicks on a directory. <br>
 *          1.6.1 2006-02-06 Take infos from AliasFileSystemTreeModel.Node
 *          instead of from File objects to reduce the amount of IO operations.
 *          <br>
 *          1.6 2005-11-26 VolumesRenderer retrieves file icons from the
 *          SidebarListModel. <br>
 *          1.5.2 2005-11-13 Don't change text of fileNameTextField, when it has
 *          focus. <br>
 *          1.5.1 2005-11-07 Get "Labels" resource bundle from UIManager. <br>
 *          1.5 2005-09-11 Celltips for browser added. Allways display
 *          horizontal scroll bar of JBrowser. <br>
 *          1.4.4 2005-08-25 Fixed a null pointer exception. <br>
 *          1.4.3 2005-06-21 SplitPane divider size configurable by LookAndFeel.
 *          <br>
 *          1.4.2 2005-06-05 Moved calls to System.getProperty into
 *          QuaquaManager. <br>
 *          1.4.1 2005-04-22 Tweaked the layout. <br>
 *          1.4 2005-03-22 Show as much path components as possible of
 *          non-existent files in the directory combo box. Use
 *          Locale.getDefault() in case the JFileChooser component can not
 *          provide a locale. <br>
 *          1.3.1 2004-12-28 Call clearIconCache() on the IconView, if this
 *          method is available. <br>
 *          1.3 2004-11-01 Support for dropping files on the file chooser added.
 *          File and directory selection is now handled in a more
 *          straightforward way - this may affect code that depends on the
 *          values returned by methods JFileChooser.getSelectedFiles(),
 *          JFileChooser.getSelectedFile() while the file chooser is being
 *          shown. 1.2.2 2004-10-26 setFileSelected had no effect, when a file
 *          with a relative path was used. <br>
 *          1.2.1 2004-10-21 Double clicking the browsers approves the
 *          selection. When there is an approvable selection, the approve button
 *          is made the default button. <br>
 *          1.2 2004-10-17 Resolve alias files. Do not clear fileName text
 *          field, when the user selects a directory. Volumes list did not
 *          update properly when a volume was added/removed. Handle relative
 *          path names. Display the real name of a file in the file name text
 *          field. Enable the approve button only, when the right kind of file
 *          (or directory) is selected. Treat non-traversable directories like
 *          files. Selecting a file in the volumes list, sets the current
 *          directory to that file. Fixed a bug where the file name in the file
 *          name field was used to determine the approved file altough the field
 *          was not visible. <br>
 *          1.1.2 2004-09-11 Fixed IndexOutOfBoundsException caused by method
 *          addItem of inner class DirectoryComboBoxModel. Replaced all method
 *          invocations to method QuaquaManager.getProperty to
 *          QuaquaManager.getProperty. <br>
 *          1.1.1 2004-08-28 Set the FileView of the JFileChooser. <br>
 *          1.1 2004-07-31 Set the text of the approve button to "Choose", when
 *          directory selection is enabled. Fixed layout issue with
 *          fileNameTextField. 1.0 2004-07-04 Created.
 */
public class QuaquaPantherFileChooserUI extends BasicFileChooserUI {
    ...
    private String newFolderDialogPrompt, newFolderDefaultName,
            newFolderErrorText, newFolderExistsErrorText, newFolderTitleText;
    ...
    /**
     * This listener is used to handle files that were dropped on the file
     * chooser.
     */
    ...
    /**
     * Values greater zero indicate that the UI is adjusting. This is required
     * to prevent the UI from changing the FileChooser's state while processing
     * a PropertyChangeEvent fired from the FileChooser.
     */
    ...
    public void installComponents(JFileChooser fc) {
        ...
        sidebarList = new javax.swing.JList() {
             ...
             * 
             */
            private static final long serialVersionUID = 6310481175502546982L;
        ...
        fc.setBorder(new javax.swing.border.EmptyBorder(new java.awt.Insets(6,
                0, 10, 0)));
        fileNamePanel.setLayout(new java.awt.GridBagLayout());

        fileNamePanel.setBorder(new javax.swing.border.EmptyBorder(
                new java.awt.Insets(4, 0, 3, 0)));
        ...
        navigationPanel.setBorder(new javax.swing.border.EmptyBorder(
                new java.awt.Insets(0, 8, 4, 8)));
        ...
        previousButton
                .setIcon(new javax.swing.ImageIcon(
                        getClass()
                                .getResource(
                                        "/ch/randelshofer/quaqua/panther/images/FileChooser.previousIcon.png")));
        ...
        nextButton
                .setIcon(new javax.swing.ImageIcon(
                        getClass()
                                .getResource(
                                        "/ch/randelshofer/quaqua/panther/images/FileChooser.nextIcon.png")));
        ...
        tableToggleButton
                .setIcon(new javax.swing.ImageIcon(
                        getClass()
                                .getResource(
                                        "/ch/randelshofer/quaqua/panther/images/FileChooser.tableIcon.png")));
        ...
        browserToggleButton
                .setIcon(new javax.swing.ImageIcon(
                        getClass()
                                .getResource(
                                        "/ch/randelshofer/quaqua/panther/images/FileChooser.browserIcon.png")));
        ...
        splitPane.setBorder(new javax.swing.border.EmptyBorder(
                new java.awt.Insets(0, 8, 0, 8)));
        ...
        controlsPanel.setLayout(new javax.swing.BoxLayout(controlsPanel,
                javax.swing.BoxLayout.Y_AXIS));

        accessoryPanel.setLayout(new java.awt.BorderLayout());

        accessoryPanel.setBorder(new javax.swing.border.EmptyBorder(
                new java.awt.Insets(6, 8, 0, 8)));
        controlsPanel.add(accessoryPanel);

        formatPanel.setLayout(new java.awt.GridBagLayout());

        formatPanel.setBorder(new javax.swing.border.EmptyBorder(
        ...
        // Configure JBrowser
        browser.setCellRenderer(new FileRenderer(fc, UIManager
                .getIcon("Browser.expandingIcon"), UIManager
                .getIcon("Browser.expandedIcon"), UIManager
                .getIcon("Browser.selectedExpandingIcon"), UIManager
                .getIcon("Browser.selectedExpandedIcon")));
        ...
        browser.setPrototypeCellValue(getFileSystemTreeModel()
                .getPrototypeValue());
        ...
        browserScrollPane.putClientProperty("Quaqua.Component.visualMargin",
                new Insets(3, 2, 3, 2));
        browserScrollPane
                .setHorizontalScrollBarPolicy(JScrollPane.HORIZONTAL_SCROLLBAR_ALWAYS);
        browser.setShowCellTipOrigin((Point) UIManager
                .get("FileChooser.cellTipOrigin"));
        browser.setShowCellTips(true);

        // Configure Sidebar Panel
        sidebarScrollPane.putClientProperty("Quaqua.Component.visualMargin",
                new Insets(3, 2, 3, 2));
        ...
        separator.putClientProperty("Quaqua.Component.visualMargin",
                new Insets(3, 0, 3, 0));
        ...
        sidebarList.setModel(sidebarListModel = new SidebarListModel(fc,
                new TreePath(getFileSystemTreeModel().getRoot()),
        ...
        fileNameTextField.getDocument().addDocumentListener(
                new SaveTextDocumentListener());
        fileNameTextField.addActionListener(getApproveSelectionAction());
        sidebarList
                .addListSelectionListener(createVolumesSelectionListener(fc));
        ...
        Component[] dropComponents = { fc, accessoryPanel, approveButton,
                browser, browserScrollPane, browserToggleButton, buttonsPanel,
                cancelButton, controlsPanel, directoryComboBox, fileNameLabel,
                fileNamePanel, fileNameSpringPanel, fileNameTextField,
                filesOfTypeLabel, filterComboBox,
                ...
                navigationSpringPanel, newFolderButton, nextButton,
                previousButton, separator, splitPane, table, tableScrollPane,
                tableToggleButton,

                viewsPanel, sidebarList, sidebarScrollPane };
        for (int i = 0; i < dropComponents.length; i++) {
            new DropTarget(dropComponents[i], DnDConstants.ACTION_COPY,
                    fileTransferHandler);
        }
        ...
        ResourceBundleUtil bundle = (ResourceBundleUtil) UIManager
                .get("Labels");
        boolean isLocalized = bundle.getLocale().getLanguage().equals(
                getLocale().getLanguage());
        browser.setPreviewRenderer(isSave || !isLocalized ? null
                : new FilePreview(fc));
    }
    ...
    /**
     * Installs listeners. We install the same listeners as BasicFileChooserUI
     * plus an AncestorListener and a property change listener.
     */
    @Override
    ...
    protected void installStrings(JFileChooser fc) {
        ...
        chooseButtonText = UIManager
                .getString("FileChooser.chooseButtonText"/* ,l */);

        fileNameLabelMnemonic = UIManager
                .getInt("FileChooser.fileNameLabelMnemonic");
        fileNameLabelText = UIManager
                .getString("FileChooser.fileNameLabelText"/* ,l */);
        // XXX - Localize "Save as:" text.
        // if (fileNameLabelText == null ||
        // fileNameLabelText.charAt(fileNameLabelText.length() -1) != ':')
        // fileNameLabelText = "Save as:";

        filesOfTypeLabelMnemonic = UIManager
                .getInt("FileChooser.filesOfTypeLabelMnemonic");
        filesOfTypeLabelText = UIManager
                .getString("FileChooser.filesOfTypeLabelText"/* ,l */);

        upFolderToolTipText = UIManager
                .getString("FileChooser.upFolderToolTipText"/* ,l */);
        upFolderAccessibleName = UIManager
                .getString("FileChooser.upFolderAccessibleName"/* ,l */);

        homeFolderToolTipText = UIManager
                .getString("FileChooser.homeFolderToolTipText"/* ,l */);
        homeFolderAccessibleName = UIManager
                .getString("FileChooser.homeFolderAccessibleName"/* ,l */);

        newFolderToolTipText = UIManager
                .getString("FileChooser.newFolderText"/* ,l */);
        newFolderAccessibleName = UIManager
                .getString("FileChooser.newFolderAccessibleName"/* ,l */);

        newFolderToolTipText = UIManager
                .getString("FileChooser.newFolderToolTipText"/* ,l */);
        newFolderAccessibleName = UIManager
                .getString("FileChooser.newFolderAccessibleName"/* ,l */);

        // New Folder Dialog
        newFolderErrorText = getString("FileChooser.newFolderErrorText", l,
                "Error occured during folder creation");
        newFolderExistsErrorText = getString(
                "FileChooser.newFolderExistsErrorText", l,
                "That name is already taken");
        // FIXME - There is no "FileChooser.newFolderText", so we use the
        // newFolderTitleText.
        newFolderText = getString("FileChooser.newFolderTitleText", l,
                "New Folder");
        newFolderTitleText = getString("FileChooser.newFolderTitleText", l,
                "New Folder");
        newFolderDialogPrompt = getString("FileChooser.newFolderPromptText", l,
                "Name of new folder:");
        newFolderDefaultName = getString("FileChooser.untitledFolderName", l,
                "untitled folder");
        newFolderToolTipText = UIManager
                .getString("FileChooser.newFolderToolTipText"/* , l */);
        newFolderAccessibleName = getString(
                "FileChooser.newFolderAccessibleName", l, newFolderTitleText);
    }
    ...
    /**
     * Creates an AncestorListener. The AncestorListener is used to take an
     * action when the JFileChooser becomes showing on screen.
     */
    ...
    public void createModel() {
        ...
        if (QuaquaManager.getBoolean("FileChooser.speed")) {
            ...
            fileView = QuaquaFileSystemView.getQuaquaFileSystemView()
                    .createFileView(fc);
        }
    ...
    /**
     * The array contains the selected file(s) of the JFileChooser. All files
     * have an absolute path. If no file is selected, the length of the array is
     * 0. Always returns a non-null value. All array elements are non-null.
     */
        ...
        if (fc.isMultiSelectionEnabled()) {
            ...
            for (int i = 0; i < selectedFiles.length; i++) {
                if (selectedFiles[i] != null) {
                    if (selectedFiles[i].isAbsolute()) {
                        ...
                        list.add(new File(QuaquaManager
                                .getProperty("user.home"), selectedFiles[i]
                                .getName()));
                    }
                }
            }
            ...
            if (f == null) {
                ...
                if (f.isAbsolute()) {
                    ...
                    return new File[] { new File(QuaquaManager
                            .getProperty("user.home"), f.getName()) };
                }
            }
        }
    }
    ...
    /**
     * Updates the selection in the JBrowser, to match the selected file/s of
     * the JFileChooser.
     */
    private void updateSelection() {
        ...
        if (files.length != 0) {
            ...
            for (int i = 0; i < files.length; i++) {
                ...
                fullPath = getFileSystemTreeModel().toPath(file,
                        subtreeModel.toFullPath(browser.getSelectionPath()));
                AliasFileSystemTreeModel.Node node = (AliasFileSystemTreeModel.Node) fullPath
                ...
                if (files.length == 1 || !isDirectory
                    ...
                    TreePath parentPath = subPath == null ? null : subPath
                            .getParentPath();
                    if (list.size() == 0) {
                        commonParentPath = parentPath;
                    }
                    if (parentPath == null && commonParentPath == null
                            || parentPath != null && commonParentPath != null
                            && parentPath.equals(commonParentPath)) {
                        list.add(subPath);
                    }
                }
            }
            if (list.size() == 0 && files.length > 0) {
                ...
                /*
                 * // Set the file name, if it does not exist if (!
                 * files[0].exists()) { setFileName(files[0].getName()); }
                 */
            }
            browser.setSelectionPaths((TreePath[]) list
                    .toArray(new TreePath[list.size()]));
        ...
        if (fullPath != null && fullPath.getPathCount() > 0) {
            AliasFileSystemTreeModel.Node node = (AliasFileSystemTreeModel.Node) fullPath
                    .getLastPathComponent();
            directoryComboBoxModel.setPath(node.isLeaf() ? fullPath
                    .getParentPath() : fullPath);

        }

        // Note: we are doing here redundant things as in method
        // updateAproveButtonState()
    ...
    private void updateApproveButtonState() {
        ...
        if (fc.getControlButtonsAreShown()) {
            ...
            switch (fc.getFileSelectionMode()) {
                case JFileChooser.FILES_ONLY:
                    isEnabled = isFileSelected || isFileNameFieldVisible()
                            && isFileNameFieldValid();
                    break;
                case JFileChooser.DIRECTORIES_ONLY:
                    isEnabled = !isFileSelected || files.length == 1
                            && !files[0].exists();
                    break;
                case JFileChooser.FILES_AND_DIRECTORIES:
                    isEnabled = true;
    ...
    protected TreeSelectionListener createBrowserSelectionListener(
            JFileChooser fc) {
    ...
    protected class BrowserSelectionListener implements TreeSelectionListener {
        public void valueChanged(TreeSelectionEvent e) {
            ...
            for (int i = 0; i < files.length; i++) {
                AliasFileSystemTreeModel.Node node = (AliasFileSystemTreeModel.Node) paths[i]
                        .getLastPathComponent();
            ...
            if (fc.isMultiSelectionEnabled()) {
                fc.setSelectedFiles((File[]) list
                        .toArray(new File[list.size()]));
            } else {
                fc.setSelectedFile(list.size() > 0 ? (File) list.get(0)
                        : null);
            }
        }
    }
    ...
    public Dimension getPreferredSize(JComponent c) {
        /*
         * Dimension d = c.getLayout().preferredLayoutSize(c); if (d != null) {
         * return new Dimension( Math.max(d.width, PREF_SIZE.width),
         * Math.max(d.height, PREF_SIZE.height) ); } else { return new
         * Dimension(PREF_SIZE.width, PREF_SIZE.height); }
         */
        ...
        return new PropertyChangeListener() {
            public void propertyChange(PropertyChangeEvent e) {
                ...
                if (s.equals(JFileChooser.SELECTED_FILE_CHANGED_PROPERTY)) {
                    ...
                    /*
                     * FIXME - This needs JDK 1.4 to work. ComponentOrientation
                     * o = (ComponentOrientation)e.getNewValue(); JFileChooser
                     * fc = (JFileChooser)e.getSource(); if (o !=
                     * (ComponentOrientation)e.getOldValue()) {
                    ...
                    if (e.getOldValue() == null && e.getNewValue() != null) {
                        ...
                        // set initial focus
                        ensurePathIsVisible(subtreeModel.toFullPath(browser
                                .getSelectionPath()));
    ...
    private void ensurePathIsVisible(TreePath path) {
        if (!subtreeModel.isSubPath(path.getPath())) {
            isAdjusting++;
            if (((AliasFileSystemTreeModel.Node) path.getLastPathComponent())
                    .isLeaf()) {
    ...
    public void setFileName(String filename) {
        if (fileNameTextField != null
                ...
                && (filename == null || !fileNameTextField.getText().equals(
                        filename))) {
    ...
    protected ListSelectionListener createVolumesSelectionListener(
            JFileChooser fc) {
    ...
    class DirectoryComboBoxRenderer extends DefaultListCellRenderer {
         ...
         * 
         */
        private static final long serialVersionUID = -3470800726013495485L;
        ...
        public Component getListCellRendererComponent(JList list, Object value,
            ...
            if (node == null) {
                ...
                /*
                 * File root = new File("/");
                 * setText(getFileChooser().getName(root)); ii.icon =
                 * getFileChooser().getIcon(root);
                 */
            } else {
    ...
    class VolumesRenderer extends DefaultListCellRenderer {
         ...
         * 
         */
        private static final long serialVersionUID = -8716394469816260850L;

        /*
         * private final Border selectedBorder = new MatteBorder(1,0,1,0, new
         * Color(7,131,216)); private final Border selectedBorderI = new
         * MatteBorder(1,0,1,0, new Color(130,129,129)); private final Border
         * normalBorder = new EmptyBorder(1,0,1,0); private final ColorPaint
         * selectedBackground = new ColorPaint(0,96,255, new
         * GradientPaint(0f,0f,new Color(62,155,228),0f,22f,new
         * Color(0,96,255))); private final ColorPaint selectedBackgroundI = new
         * ColorPaint(102,102,102, new GradientPaint(0f,0f,new
         * Color(151,151,151),0f,22f,new Color(102,102,102)));
         */
        ...
        private JComponent separator = new JComponent() {
             ...
             * 
             */
            private static final long serialVersionUID = 4736426883786380078L;
        ...
        protected void paintComponent(Graphics gr) {
            ...
            switch (backgroundIndex) {
                ...
                case 1:
                    ...
                    g.setPaint(new GradientPaint(0f, 1f,
                            new Color(62, 155, 228), 0f, height - 2, new Color(
                                    0, 96, 255)));
                ...
                case 2:
                    ...
                    g.fillRect(0, 0, width, 1);
                    g.setPaint(new GradientPaint(0f, 1f, new Color(151, 151,
                            151), 0f, height - 2, new Color(102, 102, 102)));
                    g.fillRect(0, 1, width, height - 1);
                    setOpaque(false);
                    break;
            }
    ...
    class IndentIcon implements Icon {
        ...
        public int getIconWidth() {
            return icon == null ? depth * space : icon.getIconWidth() + depth
                    * space;
        }
    ...
    /**
     * Data model for a directory selection combo-box. There is always one node
     * in the tree model: the file system root (aka the comouter).
     */
    protected class DirectoryComboBoxModel extends AbstractListModel implements
         ...
         * 
         */
        private static final long serialVersionUID = -6891877901187497816L;
        ...
        /**
         * Sets the path of the directory combo box. TreePath<AliasFileSystemTreeModel.Node>
         */
        private void setPath(TreePath path) {
            ...
            /*
             * // FIXME - This method needs optimization. // Change method
             * signature: We must pass a AliasFileSystemTreeModel.Node
             * 
             * 
             * File selectedDir = (File) getSelectedItem(); if (selectedDir !=
             * null && directory != null && selectedDir.equals(directory)) {
             * return; } long start = System.currentTimeMillis();
             * 
             * FileSystemView fsv = chooser.getFileSystemView(); if (! (fsv
             * instanceof QuaquaFileSystemView)) { fsv =
             * QuaquaFileSystemView.getQuaquaFileSystemView(); }
             * 
             * isAdjusting++;
             * 
             * 
             * 
             * int size = path.size(); path.clear(); if (size > 0) {
             * fireIntervalRemoved(this, 0, size - 1); } /* Not needed. We
             * require that the file is a directory in the API. while (directory !=
             * null && ! directory.isDirectory()) { directory =
             * fsv.getParentDirectory(directory); }* / if (directory == null)
             * directory = fsv.getRoots()[0];
             * 
             * for (File f = directory; f != null; f =
             * fsv.getParentDirectory(f)) { path.add(f); } if (path.size() == 0 || !
             * path.get(0).equals(computer)) { path.add(computer); }
             * 
             * if (path.size() > 0) { fireIntervalAdded(this, 0, path.size() -
             * 1); } setSelectedItem(directory);
             * 
             * isAdjusting--; long end = System.currentTimeMillis();
             * System.out.println("QuaquaPanttherFileChooserUI.DirectoryCombo.add
             * "+(end-start));
             */
        }
    ...
    public class FilterComboBoxRenderer extends DefaultListCellRenderer {
         ...
         * 
         */
        private static final long serialVersionUID = 1958741254345294430L;
    ...
    protected class FilterComboBoxModel extends AbstractListModel implements
         ...
         * 
         */
        private static final long serialVersionUID = 4564161675350381712L;
    ...
    protected class DirectoryComboBoxAction extends AbstractAction {
         ...
         * 
         */
        private static final long serialVersionUID = 2752751177519248331L;
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            JFileChooser fc = getFileChooser();
            AliasFileSystemTreeModel.Node node = (AliasFileSystemTreeModel.Node) directoryComboBox
                    .getSelectedItem();
            if (node != null) {
                File file = node.getFile();
                if (fc.isMultiSelectionEnabled()) {
    ...
    /**
     * This method is called, when the user double clicks the JBrowser, or when
     * she clicks at the approve button.
     * 
     * @param allowDirectories
     *            true to allow selection of directories when
    ...
    private void maybeApproveSelection(boolean allowDirectories) {
        ...
        if (fc.isMultiSelectionEnabled()) {
            ...
            if (filename != null) {
                selectedFiles = new File[] { new File(
                        ((AliasFileSystemTreeModel.Node) selectedPaths[0]
                                .getLastPathComponent()).getFile().getParent(),
                        filename) };
            } else {
                selectedFiles = new File[selectedPaths.length];
                for (int i = 0; i < selectedPaths.length; i++) {
                    selectedFiles[i] = ((AliasFileSystemTreeModel.Node) selectedPaths[i]
            ...
            if (!allowDirectories && selectedFiles.length == 1
                    && selectedFiles[0].isDirectory()) {
                // block selection
                return;
            }
        } else {
            AliasFileSystemTreeModel.Node node = (AliasFileSystemTreeModel.Node) browser
                    .getSelectionPath().getLastPathComponent();
            selectedFile = node.getFile();
            if (filename != null) {
                selectedFile = new File(!node.isLeaf() ? selectedFile
                        : selectedFile.getParentFile(), filename);
    ...
    protected class NewFolderAction extends AbstractAction {
         ...
         * 
         */
        private static final long serialVersionUID = 6498567146409689288L;
        ...
        private String showNewFolderDialog() {
            JOptionPane optionPane = new JOptionPane(newFolderDialogPrompt,
                    JOptionPane.PLAIN_MESSAGE, JOptionPane.OK_CANCEL_OPTION);
            optionPane.setWantsInput(true);
            optionPane.setInitialSelectionValue(newFolderDefaultName);
            JDialog dialog = optionPane.createDialog(getFileChooser(),
                    newFolderTitleText);
            dialog.show();
            dialog.dispose();

            return optionPane.getInputValue() == JOptionPane.UNINITIALIZED_VALUE ? null
                    : (String) optionPane.getInputValue();
        }
        ...
        public void actionPerformed(ActionEvent actionevent) {
            ...
            if (newFolderName != null) {
                ...
                if (newFolder.exists()) {
                    JOptionPane.showMessageDialog(fc, newFolderExistsErrorText,
            ...
            SwingUtilities.invokeLater(new Runnable() {
                public void run() {
                    ...
                    if (fileNameTextField.getText().length() != 0) {
                        if (!node.isLeaf()) {
                            // Don't change the current directory when the user
                            // is entering
                            // text into the text field. It confuses our users!
                            // Instead, we update the state of the approve
                            // button
                            ...
                            file = new File(fc.getFileSystemView()
    ...
    /**
     * The FileChooserAncestorListener listens for visibility changes of the
     * JFileChooser. This is used to do validations (refreshes) of the tree
     * model only, when the JFileChooser is showing.
     */
    private class FileChooserAncestorListener implements AncestorListener {
        public void ancestorAdded(AncestorEvent event) {
            if (model != null) {
                model.setAutoValidate(QuaquaManager
                        .getBoolean("FileChooser.autovalidate"));
                model.validatePath(browser.getSelectionPath());
                if (sidebarListModel != null) {
                    sidebarListModel.lazyValidate();
                }
            }
            // QuaquaUtilities.setWindowAlpha(SwingUtilities.getWindowAncestor(event.getAncestorParent()),
            // 230);
        }
    ...
    public void ensureFileIsVisible(JFileChooser fc, File f) {
        if (f != null) {
            ...
            if (subPath == null) {
                isAdjusting++;
                getTreeModel().setPathToRoot(
                        new Object[] { fullPath.getPathComponent(0) });
                isAdjusting--;
                subPath = fullPath;
            }
    ...
    public void clearIconCache() {
        try {
            fileView.getClass().getMethod("clearIconCache", new Class[0])
        ...
        public void valueChanged(ListSelectionEvent e) {
            ...
            if (sidebarList != null) {
                ...
                if (info != null) {
                    ...
                    isAdjusting++;
                    subtreeModel.setPathToRoot(model.toPath(info.getFile(),
                            new TreePath(subtreeModel.toFullPath(
                                    browser.getSelectionPath()).getPath())));
                    isAdjusting--;
                    if (fc.isMultiSelectionEnabled()) {
    ...
    protected class QuaquaApproveSelectionAction extends AbstractAction {
         ...
         * 
         */
        private static final long serialVersionUID = 8502490377915027288L;
