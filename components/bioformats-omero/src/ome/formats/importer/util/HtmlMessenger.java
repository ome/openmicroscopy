 ...
 * @author TheBrain
 * 
 * This class allows you to submit a URL and a String hashmap of key-value pairs
 * to be posted to the url in question.
 */
public class HtmlMessenger {
    ...
    public HtmlMessenger(String url, Map<String, String> postHashMap)
        ...
        try {
            ...
            throw new HtmlMessengerException("Error creating post parameters",
                    e);
        }
