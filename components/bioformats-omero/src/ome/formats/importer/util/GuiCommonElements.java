...
public class GuiCommonElements {
    ...
    public JPanel addMainPanel(Container container, double tableSize[][],
            ...
            int margin_right, boolean debug) {
    ...
    public JTextField addTextField(Container container, String name,
            String initialValue, int mnemonic, String tooltip, String suffix,
    ...
    public JTextArea addTextArea(Container container, String name, String text,
            int mnemonic, String placement, boolean debug) {
        JPanel panel = new JPanel();
        panel.setOpaque(false);
    ...
    public JTextPane addTextPane(Container container, String name, String text,
            int mnemonic, String placement, boolean debug) {
        JPanel panel = new JPanel();
        panel.setOpaque(false);
     ...
     */
    public void appendTextToDocument(StyledDocument doc, Style style,
            String text) {
        try {
    ...
    public JButton addButton(Container container, String label, int mnemonic,
            String tooltip, String placement, boolean debug) {
