...
public class FileQueueHandler extends JPanel implements ActionListener,
        ...
        if (action.equals(JFileChooser.APPROVE_SELECTION)) {
            ...
            if (store != null) {
                ...
                addFileToQueue(file, dialog.dataset, dialog.dataset.getName(),
                        ...
                        dialog.numOfDirectories, dialog.archiveImage
                                .isSelected());
            } else {
                JOptionPane
                        .showMessageDialog(
    ...
    public void propertyChange(PropertyChangeEvent e) {
        ...
        if (prop.equals(JFileChooser.DIRECTORY_CHANGED_PROPERTY)) {
            savedDirectory = fileChooser.getCurrentDirectory()
                    .getAbsolutePath();
    ...
    private void addFileToQueue(File file, Dataset dataset, String dName,
            String project, Boolean useFullPath, int numOfDirectories,
            boolean archiveImage) {
