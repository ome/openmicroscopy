...
import ome.server.itests.sec.LdapTest;
import ome.services.ldap.AbstractLdapTest;
import ome.services.ldap.Fixture;
import ome.services.ldap.UnitFixture;

import org.springframework.beans.FatalBeanException;
import org.testng.annotations.Test;

/**
 * Extends {@link LdapTest} to check that on startup OMERO properly throws an
 * exception if the LDAP connection is invalid.
 */
@Test(groups = { "ldap", "ticket:1253" })
public class LdapInitTest
    extends AbstractLdapTest
{
    ...
    public void testInit()
        throws Exception
    {
        File file = getLdifContextFile("testInit");
        assertLdifFile(file);
    }
}
