...
public class ModelTest extends AbstractDependencyInjectionSpringContextTests {
	...
	protected void onSetUp() throws Exception {
	    up = (IUpdate) applicationContext.getBean("updateService");
        q  = (IQuery) applicationContext.getBean("queryService");
	}
...
//		d2.setLogs(l);
//		
//		up.saveArray(new IObject[]{e,l,d1,d2});
	...
	public void testVersionShouldIncreate(){
		Image i = (Image) q.queryList("from Image i where i.version is not null",null).get(0);
		up.saveObject(i);
		Image i2 = (Image) q.getById(Image.class,i.getId());
