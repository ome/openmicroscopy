...
public class AbstractInternalContextTest extends
    ...
    protected void onSetUpBeforeTransaction() throws Exception {
        ...
        serviceFactory = new InternalServiceFactory(
    ...
    protected void onSetUpInTransaction() throws Exception {
        /*
         * make sure the whole test runs within a single session, unless
    ...
    protected void closeSession() throws Exception {
        ...
        // SessionFactoryUtils.processDeferredClose(sessionFactory); // TODO see
        // OpenInView
    }
