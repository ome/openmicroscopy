/*
 * org.openmicroscopy.omero.dao.utils.ImagePlateUtils
 *
 *------------------------------------------------------------------------------
 *
...
import org.openmicroscopy.omero.model.ImagePlate;
...
public class ImagePlateUtils  extends BaseModelUtils {

  private static Log log = LogFactory.getLog(ImagePlateUtils.class);
  ...
  public void clean(Object o, Set done){
    ...
    if (null==self.getImage()){
      ...
      self.setImage(null);
         if (log.isDebugEnabled()){
             log.debug("Set ImagePlate.image to null");
         }
    } else {
    ...
    if (null==self.getModuleExecution()){
      ...
      self.setModuleExecution(null);
         if (log.isDebugEnabled()){
             log.debug("Set ImagePlate.moduleExecution to null");
         }
    } else {
