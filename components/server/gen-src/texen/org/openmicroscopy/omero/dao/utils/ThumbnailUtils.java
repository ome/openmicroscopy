/*
 * org.openmicroscopy.omero.dao.utils.ThumbnailUtils
 *
 *------------------------------------------------------------------------------
 *
...
import org.openmicroscopy.omero.model.Thumbnail;
...
public class ThumbnailUtils  extends BaseModelUtils {

  private static Log log = LogFactory.getLog(ThumbnailUtils.class);
  ...
  public void clean(Object o, Set done){
    ...
    if (null==self.getRepository()){
      ...
      self.setRepository(null);
         if (log.isDebugEnabled()){
             log.debug("Set Thumbnail.repository to null");
         }
    } else {
    ...
    if (null==self.getModuleExecution()){
      ...
      self.setModuleExecution(null);
         if (log.isDebugEnabled()){
             log.debug("Set Thumbnail.moduleExecution to null");
         }
    } else {
