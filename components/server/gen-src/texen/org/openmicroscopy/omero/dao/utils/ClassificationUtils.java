/*
 * org.openmicroscopy.omero.dao.utils.ClassificationUtils
 *
 *------------------------------------------------------------------------------
 *
...
public class ClassificationUtils  extends BaseModelUtils {

  private static Log log = LogFactory.getLog(ClassificationUtils.class);
  ...
  public void clean(Object o, Set done){
    ...
    Classification self = (Classification) o;
    // Cleaning org.openmicroscopy.omero.model.Category::category field
    if (null==self.getCategory()){
      // Do nothing
    } else if (!Hibernate.isInitialized(self.getCategory())){
      self.setCategory(null);
         if (log.isDebugEnabled()){
             log.debug("Set Classification.category to null");
         }
    } else {
      (new org.openmicroscopy.omero.model.Category()).getUtils().clean(self.getCategory(),done);
    }
    ...
    if (null==self.getImage()){
      ...
      self.setImage(null);
         if (log.isDebugEnabled()){
             log.debug("Set Classification.image to null");
         }
    } else {
    ...
    if (null==self.getModuleExecution()){
      ...
      self.setModuleExecution(null);
         if (log.isDebugEnabled()){
             log.debug("Set Classification.moduleExecution to null");
         }
    } else {
