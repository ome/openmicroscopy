/*
 * org.openmicroscopy.omero.dao.utils.ImageDimensionUtils
 *
 *------------------------------------------------------------------------------
 *
...
public class ImageDimensionUtils  extends BaseModelUtils {

  private static Log log = LogFactory.getLog(ImageDimensionUtils.class);
  ...
  public void clean(Object o, Set done){
    ...
    ImageDimension self = (ImageDimension) o;
    ...
    if (null==self.getImage()){
      ...
      self.setImage(null);
         if (log.isDebugEnabled()){
             log.debug("Set ImageDimension.image to null");
         }
    } else {
    ...
    if (null==self.getModuleExecution()){
      ...
      self.setModuleExecution(null);
         if (log.isDebugEnabled()){
             log.debug("Set ImageDimension.moduleExecution to null");
         }
    } else {
