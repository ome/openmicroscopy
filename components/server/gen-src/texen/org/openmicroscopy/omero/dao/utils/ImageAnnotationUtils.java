/*
 * org.openmicroscopy.omero.dao.utils.ImageAnnotationUtils
 *
 *------------------------------------------------------------------------------
 *
...
public class ImageAnnotationUtils  extends BaseModelUtils {

  private static Log log = LogFactory.getLog(ImageAnnotationUtils.class);
  ...
  public void clean(Object o, Set done){
    ...
    ImageAnnotation self = (ImageAnnotation) o;
    ...
    if (null==self.getImage()){
      ...
      self.setImage(null);
         if (log.isDebugEnabled()){
             log.debug("Set ImageAnnotation.image to null");
         }
    } else {
    ...
    if (null==self.getModuleExecution()){
      ...
      self.setModuleExecution(null);
         if (log.isDebugEnabled()){
             log.debug("Set ImageAnnotation.moduleExecution to null");
         }
    } else {
