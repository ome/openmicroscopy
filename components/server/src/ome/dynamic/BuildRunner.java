...
class BuildRunner {
    ...
    public static void load(String fileName) {
        ...
        String[] jars = new String[] { "st/lib/middlegen/middlegen-2.1.jar",
                "st/lib/middlegen/middlegen-hibernate-plugin-2.1.jar",
                "st/lib/middlegen/log4j-1.2.7.jar",
                "middlegen/velocity-1.4-dev.jar",
                "st/lib/middlegen/commons-collections-2.1.jar",
                "st/lib/hibernate3/hibernate-tools.jar",
                "hibernate3/hibernate3.jar",
        ...
        // if (c != null) {
        // System.out.println("xxxxxxxxxxxxxxxxxxxxxxxAlready loaded "+name+" in
        // urls.");
        // return c;
        // }
        //				
