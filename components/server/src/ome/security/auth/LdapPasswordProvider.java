...
/**
 * LDAP {@link PasswordProvider} which can create users on request. Assuming
 * that a user exists in the configured LDAP store but not in the database, then
 * a new user will be created. Authentication, however,
 * 
