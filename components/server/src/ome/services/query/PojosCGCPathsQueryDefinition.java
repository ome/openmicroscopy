...
public class PojosCGCPathsQueryDefinition extends Query {
    ...
    static Definitions defs = new Definitions(new IdsQueryParameterDef(),
            new OptionsQueryParameterDef(), new AlgorithmQueryParameterDef());
    ...
    protected void buildQuery(Session session) throws HibernateException,
        ...
        cg.setResultTransformer(Hierarchy
                .getChildTransformer(CategoryGroup.class));

        // TODO switch to new Hierarchy();
        Criteria[] h1 = Hierarchy.fetchChildren(cg, CategoryGroup.class,
                Integer.MAX_VALUE);
    ...
    protected void enableFilters(Session session) {
        ownerOrGroupFilters(session, new String[] { CategoryGroup.OWNER_FILTER,
                Category.OWNER_FILTER }, new String[] {
