...
SCP="scp -2 -vvv -o NoHostAuthenticationForLocalhost=yes -o UserKnownHostsFile=/dev/null -o StrictHostKeyChecking=no -o CheckHostIP=no -i ./omerokey -P $SSH_PF"
SSH="ssh -2 -vvv -o NoHostAuthenticationForLocalhost=yes -o UserKnownHostsFile=/dev/null -o StrictHostKeyChecking=no -o CheckHostIP=no -i ./omerokey -p $SSH_PF -t"
