    ...
    implements AgentEventListener
{
    ...
    /** 
     * Post an event to render images when a point is selected on the 
     * XYImage.
     */
    ...
    private void initComponents()
    {
        ...
        layer.add(drawing, new Integer(1));
    ...
    private void setImages(BufferedImage xzImage, BufferedImage yzImage, 
