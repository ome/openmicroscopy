/*
 * org.openmicroscopy.shoola.agents.browser.images.AbstractPaintMethod
 *
 *------------------------------------------------------------------------------
 *
...
/**
 * Abstract class version of PaintMethod (that handles referential equality
 * such that everything else in the browser system works).  Does not actually
 * specify a paint method; only specifies how equality and hash codes are
...
public abstract class AbstractPaintMethod implements PaintMethod
{
     ...
     * equality, as the only things that will differentiate PaintMethods are
