/*
 * org.openmicroscopy.shoola.agents.browser.heatmap.AbstractHeatMapMode
 *
 *------------------------------------------------------------------------------
 *
...
public abstract class AbstractHeatMapMode implements DisplayValueMode
{
    ...
    {
        if(o == null || !(o instanceof AbstractHeatMapMode))
        {
            return false;
        }
        AbstractHeatMapMode h = (AbstractHeatMapMode)o;
