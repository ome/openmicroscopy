/*
 * org.openmicroscopy.shoola.agents.annotator.AttributeEditorUIF
 *
 *------------------------------------------------------------------------------
 *
 ...
 * @since OME2.2
 */
public class AttributeEditorUIF
{
    ...
    /**
     * Construct a new AttributeEditorUIF.
     * @param control The controller for the UI.
     * @param registry The reference to the application registry.
     */
    public AttributeEditorUIF(AnnotationCtrl control, Registry registry)
    {
