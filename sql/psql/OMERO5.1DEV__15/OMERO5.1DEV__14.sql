...
---
--- OMERO5 development release upgrade from OMERO5.1DEV__14 to OMERO5.1DEV__15.
---
...
SELECT omero_assert_db_version('OMERO5.1DEV', 14);
DROP FUNCTION omero_assert_db_version(varchar, int);


INSERT INTO dbpatch (currentVersion, currentPatch,   previousVersion,     previousPatch)
             VALUES ('OMERO5.1DEV',  15,                'OMERO5.1DEV',    14);
