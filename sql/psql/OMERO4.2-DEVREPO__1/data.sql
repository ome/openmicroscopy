...
insert into dbpatch (currentVersion, currentPatch, previousVersion, previousPatch, message)
             values ('OMERO4.2-DEVREPO',  1,    'OMERO4.2-DEVREPO',   0,             'Initializing');
...
-- No unique index on (path, repo) since it depends on params
...
create unique index originalfile_repo_path_index on originalfile (path, repo) where repo is not null;
--
-- end ticket:2201
--
...
update dbpatch set message = 'Database ready.', finished = now()
  where currentVersion = 'OMERO4.2-DEVREPO' and
        currentPatch = 1 and
        previousVersion = 'OMERO4.2-DEVREPO' and
        previousPatch = 0;
