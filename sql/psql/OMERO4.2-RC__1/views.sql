...
-- with functional views.
  ...
  DROP TABLE count_PlateAcquisition_wellSampleLinks_by_owner;

  CREATE OR REPLACE VIEW count_PlateAcquisition_wellSampleLinks_by_owner (PlateAcquisition_id, owner_id, count) AS select parent, owner_id, count(*)
    FROM PlateAcquisitionWellSampleLink GROUP BY parent, owner_id ORDER BY parent;
  ...
  DROP TABLE count_WellSample_plateAcquisitionLinks_by_owner;

  CREATE OR REPLACE VIEW count_WellSample_plateAcquisitionLinks_by_owner (WellSample_id, owner_id, count) AS select child, owner_id, count(*)
    FROM PlateAcquisitionWellSampleLink GROUP BY child, owner_id ORDER BY child;
