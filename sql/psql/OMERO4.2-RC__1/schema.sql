    ...
    create table count_PlateAcquisition_wellSampleLinks_by_owner (
        PlateAcquisition_id int8 not null,
        "count" int8 not null,
        owner_id int8 not null,
        primary key (PlateAcquisition_id, owner_id)
    ...
    create table count_WellSample_plateAcquisitionLinks_by_owner (
        WellSample_id int8 not null,
        "count" int8 not null,
        owner_id int8 not null,
        primary key (WellSample_id, owner_id)
    ...
    create table plateacquisitionwellsamplelink (
        id int8 not null,
        permissions int8 not null,
        version int4,
        child int8 not null,
    ...
    alter table count_PlateAcquisition_wellSampleLinks_by_owner
        add constraint FK_count_to_PlateAcquisition_wellSampleLinks
        foreign key (PlateAcquisition_id)
        references plateacquisition;;
    ...
    alter table count_WellSample_plateAcquisitionLinks_by_owner
        add constraint FK_count_to_WellSample_plateAcquisitionLinks
        foreign key (WellSample_id)
        references wellsample;;
    ...
    alter table plateacquisition
        add constraint FKplateacquisition_screen_screen
        foreign key (screen)
        references screen;;
    ...
    alter table plateacquisitionwellsamplelink
        add constraint FKplateacquisitionwellsamplelink_child_wellsample
        foreign key (child)
        references wellsample;;

    alter table plateacquisitionwellsamplelink
        add constraint FKplateacquisitionwellsamplelink_update_id_event
        foreign key (update_id)
        references event;;

    alter table plateacquisitionwellsamplelink
        add constraint FKplateacquisitionwellsamplelink_owner_id_experimenter
        foreign key (owner_id)
        references experimenter;;

    alter table plateacquisitionwellsamplelink
        add constraint FKplateacquisitionwellsamplelink_creation_id_event
        foreign key (creation_id)
        references event;;

    alter table plateacquisitionwellsamplelink
        add constraint FKplateacquisitionwellsamplelink_parent_plateacquisition
        foreign key (parent)
        references plateacquisition;;

    alter table plateacquisitionwellsamplelink
        add constraint FKplateacquisitionwellsamplelink_group_id_experimentergroup
        foreign key (group_id)
        references experimentergroup;;

    alter table plateacquisitionwellsamplelink
        add constraint FKplateacquisitionwellsamplelink_external_id_externalinfo
        foreign key (external_id)
        references externalinfo;;
