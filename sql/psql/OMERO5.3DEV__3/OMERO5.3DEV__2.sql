...
---
--- OMERO5 development release upgrade from OMERO5.3DEV__2 to OMERO5.3DEV__3.
---
...
SELECT omero_assert_db_version('OMERO5.3DEV', 2);
...
INSERT INTO dbpatch (currentVersion, currentPatch, previousVersion, previousPatch)
             VALUES ('OMERO5.3DEV',  3,            'OMERO5.3DEV',   2);
