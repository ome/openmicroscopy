...
--
  ...
  CREATE INDEX i_reference_owner ON reference(owner_id);
  CREATE INDEX i_reference_group ON reference(group_id);
...
insert into dbpatch (currentVersion, currentPatch, previousVersion, previousPatch, message)
             values ('OMERO4.4DEV',  5,    'OMERO4.4DEV',   0,             'Initializing');
