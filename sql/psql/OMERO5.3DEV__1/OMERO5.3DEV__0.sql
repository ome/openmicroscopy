...
---
--- OMERO5 development release upgrade from OMERO5.3DEV__0 to OMERO5.3DEV__1.
---
...
SELECT omero_assert_db_version('OMERO5.3DEV', 0);
...
INSERT INTO dbpatch (currentVersion, currentPatch, previousVersion, previousPatch)
             VALUES ('OMERO5.3DEV',  1,            'OMERO5.3DEV',   0);
