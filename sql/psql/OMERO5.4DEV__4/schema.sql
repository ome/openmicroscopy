    ...
    create table inverseintensitycontext (
    ...
    alter table inverseintensitycontext 
        add constraint FKinverseintensitycontext_codomainmapcontext_id_codomainmapcontext 
        foreign key (codomainmapcontext_id) 
        references codomainmapcontext  ;;
