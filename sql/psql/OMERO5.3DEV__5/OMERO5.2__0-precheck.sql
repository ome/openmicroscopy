...
---
--- OMERO5 readiness check for upgrade from OMERO5.2__0 to OMERO5.3DEV__6.
---
...
SELECT CHR(10)||CHR(10)||CHR(10)||'YOUR DATABASE IS READY FOR UPGRADE TO VERSION OMERO5.3DEV__6'||CHR(10)||CHR(10)||CHR(10) AS Status;
