...
---
--- OMERO5 in-place upgrade for the OMERO4.4__0 database to re-enable shares.
---
...
SELECT CHR(10)||CHR(10)||CHR(10)||'SHARES HAVE BEEN RE-ENABLED FOR OMERO4.4__0'||CHR(10)||CHR(10)||CHR(10) AS Status;
