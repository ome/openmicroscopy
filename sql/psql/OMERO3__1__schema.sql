...
BEGIN;
    ...
    create table acquisitioncontext (
        id int8 not null,
        owner_id int8 not null,
        group_id int8 not null,
        creation_id int8 not null,
        ...
        photometricInterpretation int8 not null,
        mode int8 not null,
        primary key (id)
    );
    ...
    create table detectorsettings (
        ...
        external_id int8 unique,
        version int4 default 0,
        voltage float4 not null,
        gain float4 not null,
        offsetValue float4 not null,
        readRate float4 not null,
    ...
    create table dyelaser (
        laser_id int8 not null,
        version int4 default 0,
        medium int8 not null,
        primary key (laser_id)
    );

    create table dyelasermedia (
        id int8 not null,
        owner_id int8 not null,
        group_id int8 not null,
        creation_id int8 not null,
    ...
    create table excimerlasermedia (
        id int8 not null,
        owner_id int8 not null,
        group_id int8 not null,
        creation_id int8 not null,
    ...
    create table freeelectronlaser (
        laser_id int8 not null,
        version int4 default 0,
        medium int8 not null,
        primary key (laser_id)
    ...
    create table freeelectronlasermedia (
        id int8 not null,
        owner_id int8 not null,
        group_id int8 not null,
        creation_id int8 not null,
    ...
    create table laser (
        ...
        frequencyDoubled bool not null,
        pump int8,
        primary key (lightsource_id)
    );
    ...
    create table metalvaporlasermedia (
        id int8 not null,
        owner_id int8 not null,
        group_id int8 not null,
        creation_id int8 not null,
    ...
    create table objective (
        ...
        immersionMedium int8,
        aberrationCorrection int8,
        correctionCollar int8,
        instrument int8 not null,
        phaseCondenserAnnulus int4,
        irisDiaphragm int8,
        primary key (id)
    );
    ...
    create table semiconductorlaser (
        laser_id int8 not null,
        version int4 default 0,
        medium int8 not null,
        primary key (laser_id)
    ...
    create table semiconductorlasermedia (
        id int8 not null,
        owner_id int8 not null,
        group_id int8 not null,
        creation_id int8 not null,
    ...
    alter table acquisitioncontext 
        add constraint FKacquisitioncontext_update_id_event
        foreign key (update_id) 
        references event;

    alter table acquisitioncontext 
        add constraint FKacquisitioncontext_owner_id_experimenter
        foreign key (owner_id) 
        references experimenter;

    alter table acquisitioncontext 
        add constraint FKacquisitioncontext_creation_id_event
        foreign key (creation_id) 
        references event;

    alter table acquisitioncontext 
        add constraint FKacquisitioncontext_mode_acquisitionmode
        foreign key (mode) 
        references acquisitionmode;

    alter table acquisitioncontext 
        add constraint FKacquisitioncontext_external_id_externalinfo
        foreign key (external_id) 
        references externalinfo;

    alter table acquisitioncontext 
        add constraint FKacquisitioncontext_group_id_experimentergroup
        foreign key (group_id) 
        references experimentergroup;

    alter table acquisitioncontext 
        add constraint FKacquisitioncontext_photometricInterpretation_photometricinterpretation
    ...
    alter table correctioncollar 
        add constraint FKcorrectioncollar_owner_id_experimenter
        foreign key (owner_id) 
        references experimenter;

    alter table correctioncollar 
        add constraint FKcorrectioncollar_creation_id_event
        foreign key (creation_id) 
        references event;

    alter table correctioncollar 
        add constraint FKcorrectioncollar_external_id_externalinfo
        foreign key (external_id) 
        references externalinfo;

    alter table correctioncollar 
        add constraint FKcorrectioncollar_group_id_experimentergroup
        foreign key (group_id) 
        references experimentergroup;
    ...
    alter table dyelaser 
        add constraint FKdyelaser_laser_id_laser
        foreign key (laser_id) 
        references laser;

    alter table dyelaser 
        add constraint FKdyelaser_medium_dyelasermedia
        foreign key (medium) 
        references dyelasermedia;

    alter table dyelasermedia 
        add constraint FKdyelasermedia_owner_id_experimenter
        foreign key (owner_id) 
        references experimenter;

    alter table dyelasermedia 
        add constraint FKdyelasermedia_creation_id_event
        foreign key (creation_id) 
        references event;

    alter table dyelasermedia 
        add constraint FKdyelasermedia_external_id_externalinfo
        foreign key (external_id) 
        references externalinfo;

    alter table dyelasermedia 
        add constraint FKdyelasermedia_group_id_experimentergroup
        foreign key (group_id) 
        references experimentergroup;
    ...
    alter table excimerlaser 
        add constraint FKexcimerlaser_laser_id_laser
        foreign key (laser_id) 
        references laser;

    alter table excimerlaser 
        add constraint FKexcimerlaser_medium_excimerlasermedia
        foreign key (medium) 
        references excimerlasermedia;

    alter table excimerlasermedia 
        add constraint FKexcimerlasermedia_owner_id_experimenter
        foreign key (owner_id) 
        references experimenter;

    alter table excimerlasermedia 
        add constraint FKexcimerlasermedia_creation_id_event
        foreign key (creation_id) 
        references event;

    alter table excimerlasermedia 
        add constraint FKexcimerlasermedia_external_id_externalinfo
        foreign key (external_id) 
        references externalinfo;

    alter table excimerlasermedia 
        add constraint FKexcimerlasermedia_group_id_experimentergroup
        foreign key (group_id) 
        references experimentergroup;
    ...
    alter table freeelectronlaser 
        add constraint FKfreeelectronlaser_laser_id_laser
        foreign key (laser_id) 
        references laser;

    alter table freeelectronlaser 
        add constraint FKfreeelectronlaser_medium_freeelectronlasermedia
        foreign key (medium) 
        references freeelectronlasermedia;

    alter table freeelectronlasermedia 
        add constraint FKfreeelectronlasermedia_owner_id_experimenter
        foreign key (owner_id) 
        references experimenter;

    alter table freeelectronlasermedia 
        add constraint FKfreeelectronlasermedia_creation_id_event
        foreign key (creation_id) 
        references event;

    alter table freeelectronlasermedia 
        add constraint FKfreeelectronlasermedia_external_id_externalinfo
        foreign key (external_id) 
        references externalinfo;

    alter table freeelectronlasermedia 
        add constraint FKfreeelectronlasermedia_group_id_experimentergroup
        foreign key (group_id) 
        references experimentergroup;

    alter table gaslaser 
        add constraint FKgaslaser_laser_id_laser
        foreign key (laser_id) 
        references laser;

    alter table gaslaser 
        add constraint FKgaslaser_medium_gaslasermedia
        foreign key (medium) 
        references gaslasermedia;

    alter table gaslasermedia 
        add constraint FKgaslasermedia_owner_id_experimenter
        foreign key (owner_id) 
        references experimenter;

    alter table gaslasermedia 
        add constraint FKgaslasermedia_creation_id_event
        foreign key (creation_id) 
        references event;

    alter table gaslasermedia 
        add constraint FKgaslasermedia_external_id_externalinfo
        foreign key (external_id) 
        references externalinfo;

    alter table gaslasermedia 
        add constraint FKgaslasermedia_group_id_experimentergroup
        foreign key (group_id) 
        references experimentergroup;
    ...
    alter table image 
        add constraint FKimage_acquisition_objective
    ...
    alter table immersionmedium 
        add constraint FKimmersionmedium_owner_id_experimenter
        foreign key (owner_id) 
        references experimenter;

    alter table immersionmedium 
        add constraint FKimmersionmedium_creation_id_event
        foreign key (creation_id) 
        references event;

    alter table immersionmedium 
        add constraint FKimmersionmedium_external_id_externalinfo
        foreign key (external_id) 
        references externalinfo;

    alter table immersionmedium 
        add constraint FKimmersionmedium_group_id_experimentergroup
        foreign key (group_id) 
        references experimentergroup;
    ...
    alter table metalvaporlaser 
        add constraint FKmetalvaporlaser_laser_id_laser
        foreign key (laser_id) 
        references laser;

    alter table metalvaporlaser 
        add constraint FKmetalvaporlaser_medium_metalvaporlasermedia
        foreign key (medium) 
        references metalvaporlasermedia;

    alter table metalvaporlasermedia 
        add constraint FKmetalvaporlasermedia_owner_id_experimenter
        foreign key (owner_id) 
        references experimenter;

    alter table metalvaporlasermedia 
        add constraint FKmetalvaporlasermedia_creation_id_event
        foreign key (creation_id) 
        references event;

    alter table metalvaporlasermedia 
        add constraint FKmetalvaporlasermedia_external_id_externalinfo
        foreign key (external_id) 
        references externalinfo;

    alter table metalvaporlasermedia 
        add constraint FKmetalvaporlasermedia_group_id_experimentergroup
        foreign key (group_id) 
        references experimentergroup;
    ...
    alter table objective 
        add constraint FKobjective_irisDiaphragm_irisdiaphragm
        foreign key (irisDiaphragm) 
        references irisdiaphragm;
    ...
    alter table objective 
        add constraint FKobjective_immersionMedium_immersionmedium
        foreign key (immersionMedium) 
        references immersionmedium;

    alter table objective 
        add constraint FKobjective_aberrationCorrection_aberrationcorrection
        foreign key (aberrationCorrection) 
        references aberrationcorrection;
    ...
    alter table objective 
        add constraint FKobjective_correctionCollar_correctioncollar
        foreign key (correctionCollar) 
        references correctioncollar;
    ...
    alter table pixels 
        add constraint FKpixels_acquisitionContext_acquisitioncontext
        foreign key (acquisitionContext) 
        references acquisitioncontext;
    ...
    alter table semiconductorlaser 
        add constraint FKsemiconductorlaser_laser_id_laser
        foreign key (laser_id) 
        references laser;

    alter table semiconductorlaser 
        add constraint FKsemiconductorlaser_medium_semiconductorlasermedia
        foreign key (medium) 
        references semiconductorlasermedia;

    alter table semiconductorlasermedia 
        add constraint FKsemiconductorlasermedia_owner_id_experimenter
        foreign key (owner_id) 
        references experimenter;

    alter table semiconductorlasermedia 
        add constraint FKsemiconductorlasermedia_creation_id_event
        foreign key (creation_id) 
        references event;

    alter table semiconductorlasermedia 
        add constraint FKsemiconductorlasermedia_external_id_externalinfo
        foreign key (external_id) 
        references externalinfo;

    alter table semiconductorlasermedia 
        add constraint FKsemiconductorlasermedia_group_id_experimentergroup
        foreign key (group_id) 
        references experimentergroup;
    ...
    create sequence seq_acquisitioncontext;
    ...
    create sequence seq_correctioncollar;
    ...
    create sequence seq_dyelasermedia;
    ...
    create sequence seq_excimerlasermedia;
    ...
    create sequence seq_freeelectronlasermedia;

    create sequence seq_gaslasermedia;
    ...
    create sequence seq_immersionmedium;
    ...
    create sequence seq_metalvaporlasermedia;
    ...
    create sequence seq_semiconductorlasermedia;
