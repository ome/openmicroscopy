    ...
    create table wellsample (
        ...
        timepoint int4,
        version int4,
        screenAcquisition int8 not null,
        update_id int8 not null,
        well int8 not null,
        external_id int8 unique,
        creation_id int8 not null,
    ...
    alter table count_Reagent_screenLinks_by_owner 
        add constraint FK_count_to_Reagent_screenLinks 
        foreign key (reagent_id) 
        references reagent;
    ...
    alter table count_Screen_reagentLinks_by_owner 
        add constraint FK_count_to_Screen_reagentLinks 
        foreign key (screen_id) 
        references screen;
    ...
    alter table screenreagentlink 
        add constraint FKscreenreagentlink_child_reagent 
        foreign key (child) 
        references reagent;

    alter table screenreagentlink 
        add constraint FKscreenreagentlink_update_id_event 
        foreign key (update_id) 
        references event;

    alter table screenreagentlink 
        add constraint FKscreenreagentlink_owner_id_experimenter 
        foreign key (owner_id) 
        references experimenter;

    alter table screenreagentlink 
        add constraint FKscreenreagentlink_creation_id_event 
        foreign key (creation_id) 
        references event;

    alter table screenreagentlink 
        add constraint FKscreenreagentlink_parent_screen 
        foreign key (parent) 
        references screen;

    alter table screenreagentlink 
        add constraint FKscreenreagentlink_group_id_experimentergroup 
        foreign key (group_id) 
        references experimentergroup;

    alter table screenreagentlink 
        add constraint FKscreenreagentlink_external_id_externalinfo 
        foreign key (external_id) 
        references externalinfo;
    ...
    alter table wellsample 
        add constraint FKwellsample_screenAcquisition_screenacquisition 
        foreign key (screenAcquisition) 
        references screenacquisition;
