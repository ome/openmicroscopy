...
public class DataField {
	...
	MEMO_ENTRY_STEP, DROPDOWN_MENU_STEP, NUMBER_ENTRY_STEP, DATE, CUSTOM};
...
//	 the names used for the UI - MUST be in SAME ORDER as INPUT_TYPES they correspond to 
	...
	{ "Fixed", "Text", "Text Box", "Drop-down Menu", "Number", "Date", "Custom"};
	...
	public void setAttribute(String name, String value, boolean notifyObservers) {
		System.out.println("DataField.setAttribute(no notifyObservers): " + name + ", value " + value);
	...
	public void setAttribute(String name, String value) {
		System.out.println("DataField.setAttribute: " + name + ", value " + value);
		allAttributesMap.put(name, value);
...
//			 keep the original name & description (may be null)
	...
	public void notifyDataFieldObservers() {
		System.out.println("DataField.NOTIFYXMLOBSERVERS! " + getName());
		formField.dataFieldUpdated();
		fieldEditor.dataFieldUpdated();
	...
	public void setDescription(String newDescription) {
		setAttribute(DataField.DESCRIPTION, newDescription);
	}
	...
	public void setSubElementsCollapsed(boolean collapsed) {
		node.setSubElementsCollapsed(collapsed);
	}
