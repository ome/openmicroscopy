 ...
 * Carrot2 project.
 *
 * Copyright (C) 2002-2007, Dawid Weiss, Stanislaw Osinski.
 ...
 * search results acquired from a local
...
public final class LuceneExample {
     ...
     *      certain index parameters are hard-coded in this method, so you need
    ...
    private static LocalController initLocalController() throws DuplicatedKeyException {
        ...
        final String [] searchFields = {"contents"};
        final String urlField = "path";
        final String titleField = "name";
        final String summaryField = "snippet";
