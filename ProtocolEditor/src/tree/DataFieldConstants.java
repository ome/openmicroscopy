...
public class DataFieldConstants {
	...
	public static final String PROTOCOL_LINK_FIELD = "ProtocolLinkField";
	...
	MEMO_ENTRY_STEP, DROPDOWN_MENU_STEP, CHECKBOX_STEP, NUMBER_ENTRY_STEP, 
	DATE_TIME_FIELD, TIME_FIELD, LINK_FIELD, PROTOCOL_LINK_FIELD, TABLE, 
	...
	{ "Fixed", "Text  (single line)", "Text Box  (multi-line)", "Drop-down Menu", "Check-Box", "Number", "Date & Time", "Time", "Link", 
		"Protocol-Link", "Table", 
