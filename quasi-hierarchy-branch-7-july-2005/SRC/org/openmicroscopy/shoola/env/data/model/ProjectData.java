/*
 * org.openmicroscopy.shoola.env.data.model.Project
 *
 *------------------------------------------------------------------------------
 *
	...
	implements DataObject
{
	...
	public ProjectData(int id, String name, String description, int ownerID,
						String ownerFirstName, String ownerLastName, 
						String ownerEmail, String ownerInstitution, 
						int ownerGroupID, String ownerGroupName, List datasets)
	{
		this.id = id;
		this.name = name;
