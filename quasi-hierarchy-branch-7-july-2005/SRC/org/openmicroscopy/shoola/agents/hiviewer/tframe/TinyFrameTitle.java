/*
 * org.openmicroscopy.shoola.agents.hiviewer.tframe.TinyFrameTitle
 *
 *------------------------------------------------------------------------------
 *
 ...
 * @since OME2.2
 */
class TinyFrameTitle
    extends JComponent
    implements TinyFrameObserver, PropertyChangeListener
{
     ...
     */
    TinyFrameTitle(TinyFrame model)
    {
    ...
    public void attach()
    {
        model.addPropertyChangeListener(TinyFrame.TITLE_PROPERTY, this);
    ...
    public void detach()
    {
        model.removePropertyChangeListener(TinyFrame.TITLE_PROPERTY, this);
    }
