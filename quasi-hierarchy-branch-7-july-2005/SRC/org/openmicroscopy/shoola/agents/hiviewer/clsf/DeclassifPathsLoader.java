/*
 * org.openmicroscopy.shoola.agents.hiviewer.clsf.DeclassifPathsLoader
 *
 *------------------------------------------------------------------------------
 *
    ...
    extends ClassifLoader
{
     ...
     */
    DeclassifPathsLoader(Classifier classifier) { super(classifier); }
