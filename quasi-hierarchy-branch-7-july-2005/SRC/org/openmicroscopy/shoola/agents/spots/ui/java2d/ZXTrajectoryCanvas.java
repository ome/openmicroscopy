/*
 * org.openmicroscopy.shoola.agents.spots.ui.java2d.ZXTrajectoryCanvas;
 *
 *------------------------------------------------------------------------------
 *
...
/** 
 * An canvas for drawing of trajectories in the ZX plane 
 * 
...
public class ZXTrajectoryCanvas extends TrajectoryCanvas {
	
	public ZXTrajectoryCanvas(double horizMax,double vertMax) {
	...
	protected Trajectory2D getTrajectoryRendering(SpotsTrajectory t) {
		Trajectory2D p = new ZXTrajectory2D(this,t);
