/*
 * org.openmicroscopy.shoola.agents.spots.ui.java2d.YZTrajectory2D;
 *
 *------------------------------------------------------------------------------
 *
...
public class YZTrajectory2D extends Trajectory2D { 

		
	public YZTrajectory2D(TrajectoryCanvas canvas,SpotsTrajectory trajectory) {
		super(canvas,trajectory);		 
	}
	
	public float getHorizCoord(SpotsTrajectoryEntry pt,GridDimensions dimensions) {
		return (float) dimensions.getHorizCoord(pt.getY());	
	}

	public float getVertCoord(SpotsTrajectoryEntry pt,GridDimensions dimensions) {
		return (float) dimensions.getVertCoord(pt.getZ());	
	}
