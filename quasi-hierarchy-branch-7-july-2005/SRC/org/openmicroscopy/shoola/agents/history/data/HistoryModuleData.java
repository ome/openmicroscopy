/*
 * org.openmicroscopy.shoola.agents.history.data.HistoryModuleData
 *
 *------------------------------------------------------------------------------
 *
...
package org.openmicroscopy.shoola.agents.history.data;
 ...
 * of each module. For use in data history views
 * 
 ...
 * @since OME2.2
 */
public class HistoryModuleData  extends ModuleData
{
	/** 
	...
	public HistoryModuleData() {}
	
	
	/** Required by the DataObject interface. */
	public DataObject makeNew() { return new HistoryModuleData(); }
