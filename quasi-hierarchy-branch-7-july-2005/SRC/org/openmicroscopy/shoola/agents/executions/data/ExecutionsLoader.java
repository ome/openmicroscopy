/*
 * org.openmicroscopy.shoola.agents.executions.data.ChainExecutionLoader
 *
 *------------------------------------------------------------------------------
 *
 ...
 * @since OME2.2
 */
public class ExecutionsLoader extends ContentLoader
{
	private ExecutionsData chainExecutions = null;
	
	public ExecutionsLoader(final ExecutionsDataManager dataManager,
	...
	public Object getContents() {
		if (chainExecutions == null)  {
			chainExecutions = ((ExecutionsDataManager) dataManager).getChainExecutions();
		}
