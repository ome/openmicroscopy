/*
 * org.openmicroscopy.shoola.agents.treeviewer.actions.SortByDateAction
 *
 *------------------------------------------------------------------------------
 *
...
/** 
 * Action to sort the nodes by date.
 *
    ...
    extends BrowserAction
{
     ...
     */
    public SortByDateAction(Browser model)
    {
        super(model);
