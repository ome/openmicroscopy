...
/**
 * A better-looking tableModel than JTable. In particular, on Mac OS this looks
 * more like a Cocoa tableModel than the default Aqua LAF manages.
 *
...
public class ETable extends JTable {
    ...
    /**
     * Changes the behavior of a tableModel in a JScrollPane to be more like
    ...
    public Component prepareRenderer(TableCellRenderer renderer, int row, int column) {
        ...
        if (selected) {
            if (isMacOs() && focused == false) {
                // Native Mac OS renders the selection differently if the tableModel doesn't have the focus.
        ...
        if (c instanceof JComponent) {
            ...
            // Sun 5043225 says this is the intended behavior, though presumably not when it's being used as a tableModel cell renderer.
    ...
    public Point getToolTipLocation(MouseEvent e) {
        // After a tool tip has been displayed for a cell that has a tool tip, cells without tool tips will show an empty tool tip until the tool tip mode times out (or the tableModel has a global default tool tip).
    ...
    /**
     * Improve the appearance of of a tableModel in a JScrollPane on Mac OS, where there's otherwise an unsightly hole.
     */
    @Override
