...
public class CustomButton 
	 ...
	 * Eg. if you set a different border, that will be respected. 
	 * This method doesn't seem to get called again to re-set these props. 
	 */
	public void updateUI() {
		...
		int padding = UIsizes.getInstance().
			getDimension(UIsizes.EMPTY_BORDER_THINKNESS);
